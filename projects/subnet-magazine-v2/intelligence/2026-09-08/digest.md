...
- @_redteam_ (RedTeam / Innerworks, Mon, 17 Aug 2026): What if every cyberattack made your defenses stronger? That's the idea behind RedTeam (SN61), using Bittensor intelligence to build an Internet Immune System that continuously identifies, analyzes, and adapts to emerging cyber threats. Join us and @_redteam_ live for our next Subnet Spotlight to learn how they're pioneering a self-improving approach to cybersecurity, powering real-world deployments and gaining traction with enterprise customers. $TAO This Wednesday, 8/19 at 10am ET. nitter.net/i/broadcasts/1nGnRBVog…  
  http://nitter.jaydenha.uk/YumaGroup/status/2089385759312605617#m
- @_redteam_ (RedTeam / Innerworks, Mon, 17 Aug 2026): Over 1m alpha now perpetually locked via conviction on SN61. This is almost a 50% increase in less than 1 month. 90% of all future emissions stay locked.  
  http://nitter.jaydenha.uk/_redteam_/status/2089356070904901822#m
...
- @jon_durbin (Jon Durbin, Fri, 21 Aug 2026): Ternary and sparse FP4 are a match made in heaven. 2x the performance, cost is basically nothing in terms of quality since ternary already has natural sparsity. AND, you can pack those params 1.15 bits per param instead of 1.58. A petaflop... at 200 watts... Almost magic. Jon Durbin (@jon_durbin) NVIDIA B300 servers retail around $350k min, crazy power/cooling requirements/etc. (bad maths) per GPU (8) is $43,750, if you can even find them (narrator: you can't) then pay for collocation etc... 9 PFLOPS dense FP4. DGX Spark: $4700, plug in anywhere, 1 PFLOP (fp4 sparse). B300 9ish PFLOP dense FP4  
  http://nitter.jaydenha.uk/jon_durbin/status/2090779358852010165#m
...
---
_Generated at 2026-09-08T15:49:40.057644+00:00 by scripts/intel/aggregate.py. Treat this digest as input context, not as ground truth. Verify before quoting._
