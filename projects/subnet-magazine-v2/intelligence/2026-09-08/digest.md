# Intelligence Digest, 2026-09-08
...
- **Authors:** ["Robert Boswall", "Reyk Knuhtsen", "Jeremie Eliahou Ontiveros", "Oliver Kennon", "Dylan Patel"]
- **Access:** paid-preview
- **URL:** https://newsletter.semianalysis.com/p/12b-of-us-ratepayers-money-wasted
- **Corpus file:** `intelligence/_external_sources/semianalysis/2026-08-16-12b-of-us-ratepayers-money-wasted.md`

> Earlier this year, we [explained](https://open.substack.com/pub/semianalysis/p/are-ai-datacenters-increasing-electric?r=8s6hrc&utm_campaign=post&utm_medium=web) why residents of the PJM area, America’s largest electricity market, have seen their power bills rise by ~20%. We argued that the main culprit was PJM’s auction design choices and how PJM models demand and supply. To better understand the extent of the problem, our Energy Model team spent the last 6 months reverse-engineering PJM’s main
...
- @jon_durbin (Jon Durbin, Wed, 19 Aug 2026): NVIDIA B300 servers retail around $350k min, crazy power/cooling requirements/etc. (bad maths) per GPU (8) is $43,750, if you can even find them (narrator: you can't) then pay for collocation etc... 9 PFLOPS dense FP4. DGX Spark: $4700, plug in anywhere, 1 PFLOP (fp4 sparse). B300 9ish PFLOP dense FP4 super expensive impossible to collocate anywhere etc. etc., $4861.11 per PFLOP. DGX Spark $4700 plug in any 15 amp outline in any house, $4700/PFLOP (but sparse). Memory is slower, so I guess use less of it/less manipulation of it... Yep, math checks out - pretraining on decentralized DGX Spark w  
...
- @jon_durbin (Jon Durbin, Tue, 18 Aug 2026): So engy starts as explicitly non-TEE inference, but better for some reason because each instance requires 80 gpus that are flaky and slow over 25gbps interconnects. Then they realize TEE is necessary for any real use case, but TEE without open source/fixed/attested workloads is pointless because you could just change the stack to log whatever you want otherwise. So now it'll be... a chutes clone? But without any transparency, run by an anon and his many alts and lackies who are in a perpetual smear campaign against chutes? How many times to tao holders need to be rugged/deceived by anons with   
  http://nitter.jaydenha.uk/jon_durbin/status/2089746552055030227#m
- @covenant_ai (Covenant AI, Tue, 18 Aug 2026): RT @tplr_ai: Nvidia is wrapping a $500B financing plan around GPU collateral. Compute is turning into a financialized asset you can borrow…  
  http://nitter.jaydenha.uk/covenant_ai/status/2089730838992666897#m
- @JosephJacks_ (Joseph Jacks, Tue, 08 Sep 2026): Helical / Spiral geometries were discussed extensively earlier this year when we were starting to dive deep into eukaryotic microtubules. Joseph Fourier invented the Fourier transform to solve spatial diffusion. At its core, the Navier-Stokes equation is just a Fourier system feeding into itself over time: Viscosity IS a Fourier filter: It exponentially dampens high-frequency (small-scale) wave modes into heat. Advection IS Fourier self-convolution: Fluid moving itself forces wave modes to multiply, reshuffling energy across scales (turbulence). Pressure IS a geometric filter: It instantly del  
  http://nitter.jaydenha.uk/JosephJacks_/status/2097401239755743508#m
- @taomedia_ (TAO Media, Tue, 08 Sep 2026): OpenAI says its AI agent swarm solved Navier-Stokes, one of the Millennium Prize Problems. ~10,000 concurrent agents worked ~88 hours to find the construction, with another ~17 hours to formalize/verify it in Lean. tao.media/openai-says-its-ai… Link OpenAI Says Its AI Agents Solved the Navier-Stokes Millennium Prize Problem OpenAI released a proof and Lean formalization while framing the result as evidence of faster AI research progress. tao.media  
  http://nitter.jaydenha.uk/taomedia_/status/2097399126308880782#m
- @markjeffrey (Mark Jeffrey, Tue, 08 Sep 2026): That said:  
  http://nitter.jaydenha.uk/markjeffrey/status/2097396372051996966#m
- @markjeffrey (Mark Jeffrey, Tue, 08 Sep 2026): More accurate and 1000x cheaper than Fable 5.1 and GPT-6 Astra Ultra. $TAO SN44 Max (@MaxSebti) from our latest tests, processing a full football match with Fable 5.1 or GPT-6 Astra Ultra would cost 1,000 times more than with @webuildscore private track models — http://nitter.jaydenha.uk/MaxSebti/status/2097368645009653966#m  
  http://nitter.jaydenha.uk/richdotca/status/2097386812826083753#m
- @markjeffrey (Mark Jeffrey, Tue, 08 Sep 2026): This IS what it feels like watching Bittensor subnets, knowing the high quality traction going on inside of them -- and watching the subnet prices not reflect that. ... yet. :) Fundamental strength preceeds price. 𝗗𝗥𝗘𝗔𝗗 𝗕𝗢𝗡𝗚𝗢 (@DreadBong0) One of the Worlds Richest Men, Jeff Bezos talking about the $AMZN stock crash "As I watched our stock fall from $113 - $6, I was watching all of our internal business metrics getting better &amp; fast" Price is an opportunity.. Focus on what's being built $TAO $TIG $TIBBIR Video — http://nitter.jaydenha.uk/DreadBong0/status/2097380356987224453#m  
  http://nitter.jaydenha.uk/markjeffrey/status/2097382884902666740#m
- @markjeffrey (Mark Jeffrey, Tue, 08 Sep 2026): Pretty cool! :) biru (@designerbiru) Made this graphic for @stillcorecap. Really love the work they are doing. Although the Branding of Stillcore is Black/White , I wanted to try with the Bitcoin's Vibe as it resonates here. Hope you like it @markjeffrey , sharing a cool motion graphic next 👀 — http://nitter.jaydenha.uk/designerbiru/status/2097362655636070731#m  
  http://nitter.jaydenha.uk/markjeffrey/status/2097381617597903214#m
- @markjeffrey (Mark Jeffrey, Tue, 08 Sep 2026): This is very interesting for one $TAO subnet @theminos_ai @GoogleDeepMind can build a model capable of making 9 billion predictions. The question then becomes: how do you know those predictions are right? You need independent ground truth, adversarial examples, difficult edge cases, benchmark datasets and continuously refreshed evaluations. @theminos_ai fits directly into that layer. I would pay attention. Google DeepMind (@GoogleDeepMind) We’re launching AlphaGenome Atlas: an AI-powered searchable database mapping the predicted impact of all 9 billion possible single-letter DNA changes. Here’  
  http://nitter.jaydenha.uk/sobczak_mariusz/status/2097379196758634942#m
- @JosephJacks_ (Joseph Jacks, Tue, 08 Sep 2026): RT @sytses: Thanks for following my cancer journey, it has been quite the ride! I’m 16 months cancer free now. I view two people as my cofo… Link Even One Ventures — Patient First Funding the medicines that should exist. Personalized therapeutics for life-threatening diseases. evenone.ventures  
  http://nitter.jaydenha.uk/JosephJacks_/status/2097373617579589737#m
- @taomedia_ (TAO Media, Tue, 08 Sep 2026): Fresh @Hippius_cloud drive subscriptions just went live. Paid plans start at $4/month for 500 GB 👇 Hippius (@Hippius_cloud) New Hippius Drive plans are live. Small monthly price, serious storage. Free ($0): 10GB Starter ($4): 500GB Plus ($7): 2TB Max ($22): 10TB Scale ($50): 25TB End-to-end encrypted. Start free, upgrade whenever you need more space. — http://nitter.jaydenha.uk/Hippius_cloud/status/2097261129370354067#m  
  http://nitter.jaydenha.uk/taomedia_/status/2097371451892658409#m
- @JosephJacks_ (Joseph Jacks, Tue, 08 Sep 2026): It’s wild how right I was … and how ridiculed I was!!! JJ (@JosephJacks_) PREDICTION: Anthropic will surpass Alphabet in revenue by mid-2028. This is not a bull case or an acceleration scenario — it is a continuation of the curve already in evidence. Anthropic’s ARR went from $1B (Jan 2025) to $9B (Dec 2025) to $30B (Apr 2026) — a 3.3x step in a single four-month window, and the curve has been steepening, not flattening. My projection actually assumes deceleration from here: $100B by end of 2026, $340B in 2027, $850B in 2028, $1.4T in 2029, $2T by 2030. Crossover with Alphabet happens at ~$575  
  http://nitter.jaydenha.uk/JosephJacks_/status/2097348054353617065#m
- @JosephJacks_ (Joseph Jacks, Tue, 08 Sep 2026): Penrose (and I) put forth a proposed solution to the ‘hard problem’ in 1996 which may indeed hold the answer. It is based on our Orch OR theory and published in a special issue of Journal of Consciousness Studies edited by @davidchalmers It placed qualia at the level of fundamental spacetime geometry geometry (along with noncomputable Platonic values) accessed and selected by quantum processes in microtubules philpapers.org/rec/HAMCEA Chalmers had said that a solution to the hard problem would require something ‘really crazy’. But then he said ‘Orch OR was TOO crazy’ (and later banned it from   
  http://nitter.jaydenha.uk/StuartHameroff/status/2097342762605826389#m
- @KyleSamani (Kyle Samani, Tue, 08 Sep 2026): Investor barbell of the future. Links below.  
  http://nitter.jaydenha.uk/kankanivishal/status/2097325688772604092#m
- @BarrySilbert (Barry Silbert, Tue, 08 Sep 2026): $ZCSH, the world's first Zcash fund, is now available for options trading on @NYSE.  
  http://nitter.jaydenha.uk/Grayscale/status/2097323361739403543#m
- @BarrySilbert (Barry Silbert, Tue, 08 Sep 2026): Options trading is now available on $ZCSH, the world's first Zcash fund, built by @Grayscale, on @NYSE.  
  http://nitter.jaydenha.uk/ZcashETF/status/2097323339828355482#m
- @taomedia_ (TAO Media, Tue, 08 Sep 2026): Story by @thillerich12. Learn more about @lium_io on our website: tao.media/lium-tops-localmax… Link Lium Tops LocalMaxxing Qwen3.6 35B Board With 14,499 Tokens Per Second The Bittensor SN51 team says the benchmark shows how rented GPU nodes can serve open models at lower per-token costs than hosted API providers. tao.media  
  http://nitter.jaydenha.uk/taomedia_/status/2097310157617152476#m
- @taomedia_ (TAO Media, Tue, 08 Sep 2026): Article Lium Tops LocalMaxxing Qwen3.6 35B Board With 14,499 Tokens Per Second 🍄‍🟫The Bittensor SN51 team says the benchmark shows how rented GPU nodes can serve open models at lower per-token costs than hosted API providers. Lium, the Bittensor Subnet 51 GPU marketplace,  
  http://nitter.jaydenha.uk/taomedia_/status/2097309960287687030#m
- @JosephJacks_ (Joseph Jacks, Tue, 08 Sep 2026): This is insane. OpenAI could be keeping an eye on scientists’ prompts, tracking when someone seems close to a major breakthrough, and then putting its own team on the same problem using ideas from those conversations. This would let OpenAI get to the result first, steal credit, and use the achievement to improve its public image and stay ahead of Anthropic. Susan Zhang (@suchenzang) everyone getting sniped by the personal drama, but missed the more interesting unanswered question: can these labs see all your work and scoop you when the stakes are "high enough"? 🤷🏻‍♀️ — http://nitter.jaydenha.u  
  http://nitter.jaydenha.uk/advait_jayant/status/2097304746688229410#m
- @taomedia_ (TAO Media, Tue, 08 Sep 2026): Article GPT-6 Astra Scores 95% in Robocurve Robot Control Test 🎯GPT-6 Astra hit 95% on Robocurve&apos;s robot control task against Claude Fable 5.1&apos;s 40%, using 6.2x fewer output tokens at 2.3x lower cost. GPT-6 Astra scored 95% on a Robocurve robot control  
  http://nitter.jaydenha.uk/taomedia_/status/2097298779749703708#m
...
- @BarrySilbert (Barry Silbert, Tue, 08 Sep 2026): 🚨 BREAKING: 🇮🇳 Indian authorities are examining offshore crypto-to-gift-card channels that allow Indians to convert crypto into vouchers to spend on groceries, fuel, food, mobile recharges and even gold. The crypto-to-gift-card mechanism is raising tax, AML and cross-border payment concerns as it allows spending without traditional banking rails. Source: ET  
  http://nitter.jaydenha.uk/CryptooIndia/status/2097254636029915255#m
- @nigescore (Nige, Tue, 07 Jul 2026): Bandwidth is the hidden tax of edge vision. 3G, 4G, 5G, it all adds up when cameras need to send video. One click in Manako and our clients will run @vidaio_ compression models locally. Lighter clips, faster collection, lower costs. Vidaio (@vidaio_) Not all partnerships are created equal.. some open doors... others open worlds! We are proud to announce: @manakoai customers will soon be able to cut bandwidth costs with a single click. @vidaio_ 's compression models, natively integrated. Every camera intelligent AND optimised As Manako grows, Vidaio grows with it This is optimisation on the edg  
  http://nitter.jaydenha.uk/manakoai/status/2074469721416638602#m
- @const_reborn (Jacob Steeves, Tue, 01 Sep 2026): saygm.com/models/claude-fabl… Insane numbers from gm. Congrats to the team. Link claude-fable-5 API pricing — $3.60 in · $17.99 out per Mtok · SayGM claude-fable-5 API pricing and cost on SayGM, by Anthropic. Input from $3.60, output from $17.99 per million tokens — 64.0% below Anthropic. saygm.com  
  http://nitter.jaydenha.uk/const_reborn/status/2094904943853367696#m
...
- @const_reborn (Jacob Steeves, Tue, 01 Sep 2026): Another great result coming out of this competition's arena. We've hit 2,274 tok/s on our MiniMax-M3 baseline We're hard at work on integrating the next top model for our arena. Cacheon focuses on production-ready models for real enterprise use-cases with evaluations only via end-to-end testing We're excited for the submissions we'll get on our next arena. More to come.  
  http://nitter.jaydenha.uk/cacheon_ai/status/2094809099187728711#m
...
- @jon_durbin (Jon Durbin, Thu, 30 Jul 2026): Napkin math on bits per byte vocab adjusted etc, this is also beating olmoe 7b 1ba at matched tokens (which is 30% more active params, 40% more total params). Maybe competitive with MobileMoE if we did a complete several trillion token severely overtrained run. Quantile balancing LatentMoE Hybrid GDN-2/SWAX/MSA Role differentiated mixed precision I think we have a winner. More napkin math, I think this 5b model would be able to do around 1200tps inference on 5090s. Kinda want to do the full 9t token run on some 5090s of this tiny one, for funsies. Parallax-5b-instant (or we could bump total pa  
  http://nitter.jaydenha.uk/jon_durbin/status/2082968766099468651#m
...
---
_Generated at 2026-09-08T19:13:13.606531+00:00 by scripts/intel/aggregate.py. Treat this digest as input context, not as ground truth. Verify before quoting._
