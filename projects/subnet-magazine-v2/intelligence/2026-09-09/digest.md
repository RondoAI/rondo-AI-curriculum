...
- @markjeffrey (Mark Jeffrey, Tue, 08 Sep 2026): True. Nothing stops this trAIn. Raoul Pal (@RaoulGMI) What would happen if, say, OpenAI went bust? The doomers will say that's the minute the "bubble" pops. But Google or Microsoft would just buy all of their compute the next morning. Now they've got double the GPUs and they're further ahead than they were the day before. David made a great point in this clip... People keep confusing a financial event with the technology. If someone blows up, the infrastructure doesn't vanish, it just changes hands, and whoever ends up with it will have a lead nobody can close. A bankruptcy wouldn't slow the b  
  http://nitter.jaydenha.uk/markjeffrey/status/2097458088102285697#m
- @markjeffrey (Mark Jeffrey, Tue, 08 Sep 2026): Correction: all of it Jeff Park (@dgt10011) *OPENAI PLANS TO TAKE A CUT OF CUSTOMERS' AI-AIDED DISCOVERIES - THE INFORMATION send this to zero — http://nitter.jaydenha.uk/dgt10011/status/2014413779006558690#m  
  http://nitter.jaydenha.uk/dgt10011/status/2097456213621370974#m
- @markjeffrey (Mark Jeffrey, Tue, 08 Sep 2026): Oro is the first startup with a live crypto token to ever get accepted into YC. And it’s on Bittensor. A few months ago, co-founders Shardul and Seth were probably at their lowest point. They’d just been hacked, things were looking rough, and they decided to apply to YC as basically a Hail Mary. To their surprise, Bittensor, their subnet, and what they were trying to build caught some attention and they got accepted. The guys have built one of the most innovative subnet designs on Bittensor, using incentives to create a machine for collecting diverse, high-quality agent traces at scale to buil  
  http://nitter.jaydenha.uk/Old_Samster/status/2097437384854097955#m
- @a16zcrypto (a16z Crypto, Tue, 08 Sep 2026): A phrase you’ll hear a lot these next 2 weeks: market structure. Market structure means the rules of the road... - who can trade what - on which platforms - under whose watch Stocks have had these rules for 90 years. Crypto never got them. That's the gap CLARITY closes.  
  http://nitter.jaydenha.uk/a16zcrypto/status/2097426211370618988#m
- @opentensor (Opentensor Foundation, Tue, 08 Sep 2026): We're excited to announce that we're going to be joining Y Combinator in Fall 2026. The team is super pumped to be working with @golda and co to continue on our journey of creating the best in class open source models for agentic commerce. Video  
  http://nitter.jaydenha.uk/oroagents/status/2097396633764032707#m
- @a16zcrypto (a16z Crypto, Tue, 08 Sep 2026): What does the CLARITY Act actually do? Explained in 60 seconds. 👇 Video  
...
- @jtledore (Jean-Thomas Ledoré, Thu, 03 Sep 2026): Shell and ENI stations added to roll out today. Accelerate.  
...
- @lium_io (Lium, Sun, 06 Sep 2026): reproduce it in 15 mins here. github.com/Datura-ai/lium-lo… Link GitHub - Datura-ai/lium-localmaxxing: Reproduce Lium&apos;s LocalMaxxing leaderboard runs (7 boards, 20... Reproduce Lium&apos;s LocalMaxxing leaderboard runs (7 boards, 20 Verified) on a rented Lium GPU in one script — vLLM/llama.cpp recipes, measured cost per million tokens - Datura-ai/lium-localmaxxing github.com  
  http://nitter.jaydenha.uk/lium_io/status/2096626342976520327#m
...
- @lium_io (Lium, Sat, 22 Aug 2026): which is better?  
...
---
_Generated at 2026-09-09T02:32:18.261862+00:00 by scripts/intel/aggregate.py. Treat this digest as input context, not as ground truth. Verify before quoting._
