...
- **btcli** (RELEASE `v9.22.0`, 2026-05-28 23:09) v9.22.0  
  https://github.com/latent-to/btcli/releases/tag/v9.22.0
- **Bittensor SDK** (COMMIT `8725cd4`, 2026-05-28 23:04) Merge pull request #3364 from latent-to/release/10.4.0  
  https://github.com/latent-to/bittensor/commit/8725cd4c488ae1cc041f4fedc1b04fcaf188f849
- **Bittensor SDK** (RELEASE `v10.4.0`, 2026-05-28 23:04) v10.4.0  
  https://github.com/latent-to/bittensor/releases/tag/v10.4.0
- **Bittensor SDK** (COMMIT `4a5f1a0`, 2026-05-28 22:52) Merge branch 'master' into release/10.4.0  
  https://github.com/latent-to/bittensor/commit/4a5f1a0fee038769c88409df2c17b5c102982fff
- **Bittensor SDK** (COMMIT `e6e47ba`, 2026-05-28 22:48) Merge pull request #3363 from latent-to/changelog/10.4.0  
  https://github.com/latent-to/bittensor/commit/e6e47ba344fb6da8caabeb72b927bf0ca26d69f5
- **btcli** (COMMIT `dc9fe7a`, 2026-05-28 22:34) Merge pull request #980 from latent-to/release/9.22.0  
  https://github.com/latent-to/btcli/commit/dc9fe7a45e31390153d955d93bb5f6ded009117d
- **Bittensor SDK** (COMMIT `1818377`, 2026-05-28 22:13) bumping btcli version  
  https://github.com/latent-to/bittensor/commit/1818377b638721dbb626f60397522d069013bcfc
- **Bittensor SDK** (COMMIT `702ed97`, 2026-05-28 22:03) bumping version  
  https://github.com/latent-to/bittensor/commit/702ed972cd8bffc309a4e12978d32101ed2931ca
- **Bittensor SDK** (COMMIT `7cae101`, 2026-05-28 22:03) CHANGELOG.md update  
  https://github.com/latent-to/bittensor/commit/7cae101b7fd966d2832865c08946e457aa0948c6
- **btcli** (COMMIT `096890d`, 2026-05-28 21:55) Merge pull request #979 from latent-to/changelog/9220  
  https://github.com/latent-to/btcli/commit/096890da6a54c2434769a8552b5e9c4817e50394
- **btcli** (COMMIT `f6b6887`, 2026-05-28 21:52) update changelog  
  https://github.com/latent-to/btcli/commit/f6b688773c05d30ae1fe3662e24c035c19b10f66
- **btcli** (COMMIT `cc2b084`, 2026-05-28 21:52) add changelog version  
  https://github.com/latent-to/btcli/commit/cc2b084242c193260b9cebbe4a64bb2cd0b1ef7d
- **btcli** (COMMIT `944986c`, 2026-05-28 21:49) Merge pull request #978 from latent-to/feat/conviction  
  https://github.com/latent-to/btcli/commit/944986c582df79238b80423b290e79c6073770ee
- **btcli** (COMMIT `4ebb8a3`, 2026-05-28 21:05) improve move query  
  https://github.com/latent-to/btcli/commit/4ebb8a32043f88f3a0dd7a8d4614960ece67aa58
- **btcli** (COMMIT `32b8d60`, 2026-05-28 20:53) remove locks from s show  
  https://github.com/latent-to/btcli/commit/32b8d605da6fde69fe78a17cb5461d1669a5bc66
- **btcli** (COMMIT `951645d`, 2026-05-28 20:47) add btcli lock show  
  https://github.com/latent-to/btcli/commit/951645d82fc3e46e1d4e5a17b66f94f52e4b408a
- **btcli** (COMMIT `68caa5d`, 2026-05-28 20:47) add btcli lock show  
  https://github.com/latent-to/btcli/commit/68caa5dd685e07ac55ef207c0b2fe50c9fa43bdc
- **btcli** (COMMIT `5660628`, 2026-05-28 20:47) use helper for add  
  https://github.com/latent-to/btcli/commit/5660628b0ec303e57e617080d8a55aa57d6ebc93
- **Bittensor SDK** (COMMIT `8a46f7b`, 2026-05-28 20:20) Merge pull request #3361 from latent-to/feat/roman/convition-lock-support  
  https://github.com/latent-to/bittensor/commit/8a46f7b925c35be217f3ac586cddaf0ba0b8fcb7
- **Bittensor SDK** (COMMIT `3e87c5b`, 2026-05-28 19:33) update e2e tests  
  https://github.com/latent-to/bittensor/commit/3e87c5b2902cbd45284b9eb2cb09da5da0073890
- **Bittensor SDK** (COMMIT `10e6723`, 2026-05-28 19:32) fix after default is changed  
  https://github.com/latent-to/bittensor/commit/10e6723305dc8beb35e2f7cc9983930415a4dc17
- **Bittensor SDK** (COMMIT `ee72535`, 2026-05-28 18:37) alphabetical order  
  https://github.com/latent-to/bittensor/commit/ee72535efbea61d83b7950119c27cf6d162405e7
...
---
_Generated at 2026-05-29T02:40:17.440456+00:00 by scripts/intel/aggregate.py. Treat this digest as input context, not as ground truth. Verify before quoting._
