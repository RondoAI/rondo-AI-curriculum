...
subtitle: "Leaked Internal Google Document Claims Open Source AI Will Outcompete Google and OpenAI"
date: "2023-05-04"
...
post_id: 175660942
captured_at: "2026-05-16T10:53:16.883889+00:00"
---

# Google "We Have No Moat, And Neither Does OpenAI"

_Leaked Internal Google Document Claims Open Source AI Will Outcompete Google and OpenAI_
...
> **Paywalled.** Captured below is the free preview Substack renders publicly (20,204 chars of body markdown). For long-form analyses this is typically 70 to 90 percent of the article, with the final deep-dive section paywalled. The Oracle may cite the captured content; do not assert claims that depend on the paywalled tail (look for a 'This post is for paid subscribers' marker at the end of the body).
...
- Giant models are slowing us down. In the long run, the best models are the oneswhich can be iterated upon quickly. We should make small variants more than an afterthought, now that we know what is possible in the [![](https://substackcdn.com/image/fetch/$s_!_tGS!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F241fe3ef-3919-4a63-9c68-9e2e77cc2fc0_1366x588.png)](https://substackcdn.com/image/fetch/$s_!_tGS!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F241fe3ef-3919-4a63-9c68-9e2e77cc2fc0_1366x588.png)

_caption:_ https://lmsys.org/blog/2023-03-30-vicuna/
...
[Subscribe](https://newsletter.semianalysis.com/subscribe?simple=true&next=https%3A%2F%2Fnewsletter.semianalysis.com%2Fp%2Fgoogle-we-have-no-moat-and-neither&utm_source=paywall&utm_medium=web&utm_content=175660942)
