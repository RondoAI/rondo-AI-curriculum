...
subtitle: "RL Training Infrastructure, GRPO, PipelineRL, Async RL, Policy Staleness, RL Sandbox Infra, CPU Requirements, TCO Analysis, Thinking Machines Tinker"
date: "2026-06-16"
...
post_id: 201544287
captured_at: "2026-06-16T22:09:26.984461+00:00"
---
...
> **Paywalled.** Captured below is the free preview Substack renders publicly (41,080 chars of body markdown). For long-form analyses this is typically 70 to 90 percent of the article, with the final deep-dive section paywalled. The Oracle may cite the captured content; do not assert claims that depend on the paywalled tail (look for a 'This post is for paid subscribers' marker at the end of the body).
...
_caption:_ Source: Magistral, Mistral AI
...
- Batch Size: 512 samplesGroup Size: 16 rollouts per problem
...
- Generator: 128 H200 GPUs, 2x 64-GPU inference replicasPD Disaggregation: 32 prefill GPUs, 32 decode GPUs, both DP32 and EP32
...
_caption:_ Source: Kimi Researcher, Moonshot AI
...
[Subscribe](https://newsletter.semianalysis.com/subscribe?simple=true&next=https%3A%2F%2Fnewsletter.semianalysis.com%2Fp%2Frl-systems-mind-the-gap-matching&utm_source=paywall&utm_medium=web&utm_content=201544287)
