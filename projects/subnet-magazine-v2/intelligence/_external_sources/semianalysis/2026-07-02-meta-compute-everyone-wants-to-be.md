...
post_id: 204734393
captured_at: "2026-07-03T02:17:01.570954+00:00"
---
...
> **Paywalled.** Captured below is the free preview Substack renders publicly (15,630 chars of body markdown). For long-form analyses this is typically 70 to 90 percent of the article, with the final deep-dive section paywalled. The Oracle may cite the captured content; do not assert claims that depend on the paywalled tail (look for a 'This post is for paid subscribers' marker at the end of the body).
...
_caption:_ Source: SemiAnalysis Tokenomics Model, Datacenter Model
...
_caption:_ Source: SemiAnalysis, SEC, CNBC/Bloomberg/Reuters
...
- Part of it could be for internal usage only. Meta needs Claude tokens, and Anthropic can’t keep up with demand. There are also security & privacy layers. In the future, we could see other very large enterprises striking such deals, e.g. a JPMorgan probably won’t go all-in on Claude if they don’t have the security and privacy guarantees that private instances enables (in their own datacenters).
- Meta could sell Claude as a service in the same way Bedrock does. They have capacity and own the full stack, from CPU to GPU to networking, with high security. However, as a new entrant, it’ll be tough to create all the enterprise relationships that AWS has. But Meta has the option to leverage their customer base of advertisers and better integrate frontier agents and LLMs into their suite, creating a new large-scale distribution path.
- Meta could go even more vertical and start building applications. As one of the world’s largest advertising platforms, they have a path to building a Sales & Marketing powerhouse. Integrating frontier models and agents would increase their odds of building a world class solution.
...
[Subscribe](https://newsletter.semianalysis.com/subscribe?simple=true&next=https%3A%2F%2Fnewsletter.semianalysis.com%2Fp%2Fmeta-compute-everyone-wants-to-be&utm_source=paywall&utm_medium=web&utm_content=204734393)
