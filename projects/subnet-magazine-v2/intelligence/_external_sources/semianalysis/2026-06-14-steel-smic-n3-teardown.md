...
subtitle: "SMIC N+3 Node Deep Dive vs TSMC N6, TechInsights Private Equity Sale, SemiAnalysis Teardown Engineering & Evaluation Lab, HiSilicon Kirin 9030, Process Technology, Pattering, Cell Architecture"
date: "2026-06-14"
...
post_id: 199606144
captured_at: "2026-06-14T21:06:08.555108+00:00"
---
...
> **Paywalled.** Captured below is the free preview Substack renders publicly (67,970 chars of body markdown). For long-form analyses this is typically 70 to 90 percent of the article, with the final deep-dive section paywalled. The Oracle may cite the captured content; do not assert claims that depend on the paywalled tail (look for a 'This post is for paid subscribers' marker at the end of the body).
...
We found this and more in our reverse engineering and teardown where we cover SMIC’s N+3 process technology, Huawei’s packaging, memory, architecture, and more. SemiAnalysis has been building a state-of-the-art teardown lab in Oregon capable of analyzing the world’s most advanced and important chips over the last year and half. We have already generated revenue on advanced datacenter chip teardowns including our recent reverse engineering of a major TSMC customer’s COUPE CPO optical engine + EIC 3D stack.
...
_caption:_ HiSilicon Kirin 9030 die annotation. Source: SemiAnalysis
...
_caption:_ HiSilicon Kirin 9020 (left) and Kirin 9030 (right) die annotation. Source: Kurnal, SemiAnalysis
...
_caption:_ Kirin 9030 Pro and Kirin 9020 block reference. Source: SemiAnalysis
...
_caption:_ Kirin 9030 Pro vs Kirin 9020 floorplan analysis. Source: Kurnal, SemiAnalysis
...
_caption:_ MediaTek Helio G99 die annotation. Source: SemiAnalysis
...
_caption:_ Kirin 9020 TaiShan V123 (left) and Kirin 9030 TaiShan Prime (right) cores. Source: Kurnal, SemiAnalysis
...
_caption:_ Kirin 9020 TaiShan New V120 (left) and Kirin 9030 TaiShan Middle (right) cores. Source: Kurnal, SemiAnalysis
...
_caption:_ Kirin 9020 (left) and Kirin 9030 (right) Big CPU cluster. Source: Kurnal, SemiAnalysis
...
_caption:_ Kirin 9020 (left) and Kirin 9030 (right) TaiShan Tiny cores. Source: Kurnal, SemiAnalysis
...
_caption:_ Kirin 9030 Pro CPU core performance comparison. Source: Littertree66, SimpleTech, David Huang, SemiAnalysis
...
_caption:_ Kirin 9020 (left) and Kirin 9030 (right) Maleoon GPU compute units. Source: Kurnal, SemiAnalysis
...
_caption:_ Kirin 9020 Maleoon 920 (left) and Kirin 9030 Maleoon 935 (right) GPU cluster. Source: Kurnal, SemiAnalysis
...
_caption:_ Kirin 9030 Pro GPU performance comparison. Source: Notebookcheck, SemiAnalysis
...
_caption:_ Kirin 9020 (left) and Kirin 9030 (right) Ascend NPU. Source: Kurnal, SemiAnalysis
...
_caption:_ Samsung K4L2E165YD DRAM in the Kirin 9030 Pro. Top: partial die (SEC marking) and a 4-hi stack. Bottom: cross-section of both 4-hi stacks. Source: SemiAnalysis
...
_caption:_ Kirin 9030 iPoP stack. Source: SemiAnalysis
...
_caption:_ Kirin 9030 Pro packages from the Mate 80 Pro (left) and Pro Max (right). Source: SemiAnalysis
...
_caption:_ Side profile of Mate 80 Pro package after DRAM removal, showing BGAs and underfill. Source: SemiAnalysis
...
_caption:_ Intel evolution of FinFET architecture. Source: Intel
...
_caption:_ Kirin 9030 TaiShan Prime (left) and Helio G99 Cortex-A55 (right), fin profile, fin-cut, HFW 321.4 nm. Source: SemiAnalysis
...
_caption:_ SMIC N+3 fin patterning integration based on the CPU core and 8T SRAM fin patterns. Source: SemiAnalysis
...
_caption:_ Helio G99 Cortex-A55 standard cell, fin-cut (TSMC N6 HD), HFW 562.5 nm. Source: SemiAnalysis
...
_caption:_ Kirin 9030 TaiShan Prime (left), Middle (center), and Tiny (right) standard cells, fin-cut (SMIC N+3), HFW 562.5 nm. Source: SemiAnalysis
...
_caption:_ Kirin 9030 TaiShan Prime (left) and Helio G99 Cortex-A55 (right) gate profile, gate-cut, HFW 321.4 nm. Source: SemiAnalysis
...
_caption:_ Kirin 9030 TaiShan Prime (left) and Helio G99 Cortex-A55 (right) lower metals, fin-cut, HFW 562.5 nm. Source: SemiAnalysis
...
_caption:_ Simplified comparison of self-aligned double (SADP) and quadruple (SAQP) patterning. Source: SemiAnalysis
...
_caption:_ Kirin 9030 TaiShan Prime (left) and Helio G99 Cortex-A55 (right) lower metals, gate-cut, HFW 562.5 nm. Source: SemiAnalysis
...
_caption:_ Kirin 9030 Middle (left) and Helio G99 Cortex-A55 (right) metal stack, fin-cut, HFW 4.59 µm (Kirin 9030) and 3.91 µm (Helio G99). Source: SemiAnalysis
...
_caption:_ Kirin 9030 and Helio G99 metal stack pitch summary. Source: SemiAnalysis
...
_caption:_ Kirin 9030 8T SRAM, fin-cut, HFW 1.55 µm. Source: SemiAnalysis
...
_caption:_ Kirin 9030 8T SRAM, fin-cut, HFW 562.5 nm. Source: SemiAnalysis
...
_caption:_ 6T HDC (1:1:1), 6T HCC (1:2:2), and 8T HCC (1:2:2-2:2) bitcell schematics, left to right. Source: SemiAnalysis
...
_caption:_ SMIC N+3 SRAM bitcell comparison. Source: SemiAnalysis
...
_caption:_ Kirin 9020 (left) and Kirin 9030 (right) SLC bank. Source: Kurnal, SemiAnalysis
...
_caption:_ Kirin 9020 (left) and Kirin 9030 (right) big CPU cluster L3 cache bank. Source: Kurnal, SemiAnalysis
...
_caption:_ Kirin 9020 (left) and Kirin 9030 (right) prime core private L2 cache. Source: Kurnal, SemiAnalysis
...
_caption:_ Intel 4 Single Diffusion Grid with Reduced Poly End-to-End Spacing. Source: Intel, VLSI 2022
...
_caption:_ Buried power rail and backside contact approaches to backside power delivery. Source: UC San Diego, ISPD 2026
...
_caption:_ Huawei Prime Core Frequency Roadmap. Source: Huawei, SemiAnalysis
...
_caption:_ Density Roadmap for SMIC, Huawei (3D), TSMC, Intel, and Samsung. Source: Huawei, SemiAnalysis
...
_caption:_ Huawei LogicFolding Density Roadmap Compared with TSMC and Intel Stacked Logic. Source: Huawei, SemiAnalysis
...
_caption:_ A glimpse of other chips in our teardown pipeline. Source: SemiAnalysis

## This post is for paid subscribers

[Subscribe](https://newsletter.semianalysis.com/subscribe?simple=true&next=https%3A%2F%2Fnewsletter.semianalysis.com%2Fp%2Fsteel-smic-n3-teardown&utm_source=paywall&utm_medium=web&utm_content=199606144)
