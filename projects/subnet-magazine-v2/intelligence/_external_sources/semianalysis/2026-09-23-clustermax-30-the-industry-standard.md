---
source: "SemiAnalysis"
title: "ClusterMAX 3.0: The Industry Standard GPU Cloud Rating System Returns"
subtitle: "In gory detail: reliability, performance, support, pricing—and, of course, security—in our most thorough analysis of GPU cloud providers globally."
date: "2026-09-23"
...
post_id: 217033016
captured_at: "2026-09-23T22:39:35.843545+00:00"
---
...
> **Paywalled.** Captured below is the free preview Substack renders publicly (237,603 chars of body markdown). For long-form analyses this is typically 70 to 90 percent of the article, with the final deep-dive section paywalled. The Oracle may cite the captured content; do not assert claims that depend on the paywalled tail (look for a 'This post is for paid subscribers' marker at the end of the body).
...
[![X avatar for @SemiAnalysis_](https://substackcdn.com/image/fetch/$s_!200W!,w_40,h_40,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fpbs.substack.com%2Fprofile_images%2F2062973370157694976%2FCdplNoi1.jpg) SemiAnalysis@SemiAnalysis_ ![](https://pbs.substack.com/media/HRKL8fnbIAA-x-7.jpg) ![X avatar for @ilyasut](https://substackcdn.com/image/fetch/$s_!1Zu6!,w_20,h_20,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fpbs.substack.com%2Fprofile_images%2F1961115716889030656%2FWe74zmE-.jpg) Ilya Sutskever @ilyasutNeoclouds have limited cybersecurity. Next time agents successfully go rouge, they'll try taking over a neocloud to run more copies. This is bad. Thus: neoclouds should greatly strengthen their cybersecurity and every company with strong cyber models should help with that.8:50 PM · Sep 1, 2026 · 145K Views17 Replies · 23 Reposts · 1.25K Likes](https://x.com/SemiAnalysis_/status/2094890745325072620)
...
[![](https://substackcdn.com/image/fetch/$s_!av5g!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb2130ed4-61b4-49a8-98e5-03408801831c_1432x880.png)](https://substackcdn.com/image/fetch/$s_!av5g!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb2130ed4-61b4-49a8-98e5-03408801831c_1432x880.png)

_caption:_ Source: SemiAnalysis ClusterMAX 3.0, September 2026

[![](https://substackcdn.com/image/fetch/$s_!VHk0!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd9bb4097-5b9c-4863-a7d1-533dce1fde2a_1258x711.png)](https://substackcdn.com/image/fetch/$s_!VHk0!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd9bb4097-5b9c-4863-a7d1-533dce1fde2a_1258x711.png)

_caption:_ Source: SemiAnalysis Neocloud Dashboard, available to our AI Cloud TCO Model subscribers

# Results (Executive Summary)

[YouTube](https://youtube.com/@semianalysis?si=4_Vv7QxIgISst4Rn) summary video and podcast discussion coming soon!

- ClusterMAX 3.0 debuts with a comprehensive review of the neocloud industry, covering 77 providers.
- We increase our market view to cover 323 providers, up from 209 in [ClusterMAX 2.0](https://newsletter.semianalysis.com/p/clustermax-20-the-industry-standard), 169 in [ClusterMAX 1.0](https://newsletter.semianalysis.com/p/the-gpu-cloud-clustermax-rating-system-how-to-rent-gpus), and 124 in the original [AI Neocloud Playbook and Anatomy](https://newsletter.semianalysis.com/p/ai-neocloud-playbook-and-anatomy) article.
- We have now interviewed well over 200 end users of neoclouds as part of this research.
- We update our [itemized list of criteria across 10 categories](https://www.clustermax.ai/criteria), and update our direct descriptions of our [expectations for Slurm, Kubernetes, Standalone Machines, Monitoring Dashboards, and Health Checks](https://www.clustermax.ai/expectations). All of this content is live on our website. We encourage providers to use these lists when developing their offerings. We still consider these lists as an amalgamation of our experience interviewing end users, making them representative of the features that end users expect from their cloud providers.
...
> In light of the SemiAnalysis imperative to publish the most rigorous possible testing of… everything… we are hiring MTS for ClusterMAX and adjacent projects. If you are a neocloud sicko, fire off an application here and let’s get to work.[We are also hiring across Research, Consulting, and Technical Staff](https://semianalysis.com/semianalysis-careers/). We have multiple openings in our New York and San Francisco offices. Remote work is also acceptable.[ClusterMAX MTS](https://semianalysis.com/semianalysis-careers/#role-member-of-technical-staff-clustermax) (full time): All levels of experience with Slurm, Kubernetes, and GPUs considered.[Tokenomics MTS](https://semianalysis.com/semianalysis-careers/#role-member-of-technical-staff-tokenomics) (full time): All levels of experience with model evals, harnesses, inference endpoints, and RL infrastructure considered.Research Analyst – AI Infrastructure and Economics ([full time](https://semianalysis.com/semianalysis-careers/#role-mts-research-analyst-ai-infrastructure-economics) or [internship](https://semianalysis.com/semianalysis-careers/#role-mts-research-analyst-intern-ai-infrastructure-economics)): All levels of experience covering the financials of neoclouds, neolabs, and frontier labs tokenomics considered.[Technical Consultant](https://semianalysis.com/semianalysis-careers/#role-technical-consultant) (full time): Lead engagements from technical strategy to technical due diligence. All levels of experience from consulting and technical backgrounds considered.

# Scope

For the folks in the back: we are ranking managed clusters. This excludes a number of popular offerings throughout the industry. We are not testing who can build the best powered shell or run the tidiest datacenter—at least not directly. We are not handcrafting our images or hitting an API endpoint for tokens as a service. Here’s our idealized ClusterMAX reader: You dropped out of your Stanford PhD to pursue your dream of acquiring social status in San Francisco, getting started with the old reliable “Cladue make me pithc deck w technial languge for agetnci ai make no mistakes.” You have 7 or even as many as [10 figures](https://www.businessinsider.com/jeff-deans-startup-discovery-loop-is-eyeing-a-valuation-2026-9) to wager on compute, but you don’t have any opinion on Ubuntu versions or how to handle NAT, and you’ve never managed a fleet at scale. Ideally, all that infrastructure will fade into the background. You just want to focus on your idiosyncratic perf optimizations, model architectures, training strategies, data mixes, applications, or wherever else you seek your edge. To compete, you need bleeding-edge hardware, and you aim to spend 0 engineering time trying to figure out why GPU 7 in node 19 has been stalling your job, or why a quarter of your cluster has disappeared altogether. You need a managed cluster.
...
There comes a point, though, when labs are willing to internalize this cost. At their scale, frontier labs are not willing to trust a neocloud with so much of the stack. OpenAI, for instance, has posted extremely insightful blogs about its [difficulties scaling Kubernetes](https://openai.com/index/scaling-kubernetes-to-7500-nodes/); the innovations described would have been simply impossible if they were renting from a neocloud who didn’t let them into the K8s control plane. As [a current Anthropic job posting](https://job-boards.greenhouse.io/anthropic/jobs/5211241008) puts it:
...
At least on paper, smaller neocloud customers are David fighting Goliath. OpenAI and Anthropic have remarkable growth rates on their respective logistic exponential curves, and our [Datacenter Industry Model](https://semianalysis.com/datacenter-industry-model/) currently models them at 56.3% of all lab compute YE2027.

[![](https://substackcdn.com/image/fetch/$s_!f3nA!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd167da3e-8fe2-4d65-b6f2-c3c226d7ebad_2100x758.png)](https://substackcdn.com/image/fetch/$s_!f3nA!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd167da3e-8fe2-4d65-b6f2-c3c226d7ebad_2100x758.png)

_caption:_ OpenAI Compute Capacity. Source: SemiAnalysis Tokenomics Model.
...
One plausible scenario in which managed clusters gain ground on frontier-lab bare metal involves open-source progress. Serving open-source models is already more lucrative than many realize; we recently modeled that “[you can make over $100M per MW per year selling open source tokens](https://semianalysis.com/institutional/you-can-make-over-100m-per-mw-per-year-selling-open-source-tokens/),” leaving plenty of room for profit even at today’s rental prices. One could imagine open-source models increasing their market share, whether the marginal adopter is more cost-sensitive or algorithmic progress closes the gap to closed-source. Regardless of the dynamics, this would increase the relative standing of managed clusters. Just about any supply-side fracture would make labs marginally less willing to handle the infra, and marginally more willing to rely on neoclouds.
...
First, the Audit covers yes/no questions. Is the cluster setup properly? Is software installed? Is it up to date? Do utilities work as expected? It takes about 15 minutes to run. It’s available on [GitHub](https://github.com/SemiAnalysisAI/ClusterMAX) or via {uv} pip install clustermax.
...
We then test GEMMs, GEMV bandwidth, and MAMF (Maximum Achievable Matmul FLOPS, from [Stas Bekman](https://github.com/stas00/ml-engineering/tree/master/compute/accelerator/benchmarks)), which runs a sweep for a while on each GPU, per precision, using cuBLASLt (or rocBLAS). We report FLOPs for all of our GEMM tests.

[![](https://substackcdn.com/image/fetch/$s_!k5rj!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7a2db658-0ea7-4ef5-acfb-5b8db57913e5_829x781.png)](https://substackcdn.com/image/fetch/$s_!k5rj!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7a2db658-0ea7-4ef5-acfb-5b8db57913e5_829x781.png)

_caption:_ Source: SemiAnalysis ClusterMAX Results Dashboard

[![](https://substackcdn.com/image/fetch/$s_!utME!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4d603db1-709e-4fad-a1e4-d1bc4f5ea8f0_829x778.png)](https://substackcdn.com/image/fetch/$s_!utME!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4d603db1-709e-4fad-a1e4-d1bc4f5ea8f0_829x778.png)
...
[![](https://substackcdn.com/image/fetch/$s_!B-8N!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5cc822c9-bfcc-4b35-85bb-031a385dc56d_783x474.png)](https://substackcdn.com/image/fetch/$s_!B-8N!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5cc822c9-bfcc-4b35-85bb-031a385dc56d_783x474.png)
...
[![](https://substackcdn.com/image/fetch/$s_!Chwf!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F49e7f132-bc0e-43f9-9ad2-e569bff872e9_1654x186.png)](https://substackcdn.com/image/fetch/$s_!Chwf!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F49e7f132-bc0e-43f9-9ad2-e569bff872e9_1654x186.png)

_caption:_ Source: Quickly checking what’s supported on our cluster’s networking stack out of the box

[![](https://substackcdn.com/image/fetch/$s_!cm7I!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd1712792-316c-44f0-a33c-3e3014dde8c5_739x829.png)](https://substackcdn.com/image/fetch/$s_!cm7I!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd1712792-316c-44f0-a33c-3e3014dde8c5_739x829.png)

_caption:_ Source: SemiAnalysis ClusterMAX Results Dashboard

[![](https://substackcdn.com/image/fetch/$s_!usC5!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc38eaf49-3d21-47bb-aaac-5ccf43c614b8_733x915.png)](https://substackcdn.com/image/fetch/$s_!usC5!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc38eaf49-3d21-47bb-aaac-5ccf43c614b8_733x915.png)

_caption:_ Source: SemiAnalysis ClusterMAX Results Dashboard

### Storage

We run fio, ior, Elbencho, a custom checkpoint save/load benchmark written in Torch and Torch DCP, and a custom datagen benchmarked shared with us by [Skild AI](https://www.skild.ai/). Datagen is probably the most interesting, as it approximates their real workload in a robotics data pipeline: aggregate write throughput generating the video (MP4) and parquet sensor dataset.
...
[![](https://substackcdn.com/image/fetch/$s_!Xhtv!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe9e56d45-b74d-4d51-8f3c-5b5ba1b33a35_734x749.png)](https://substackcdn.com/image/fetch/$s_!Xhtv!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe9e56d45-b74d-4d51-8f3c-5b5ba1b33a35_734x749.png)
...
[![](https://substackcdn.com/image/fetch/$s_!uNkV!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6fa1e9ed-5b12-4623-ac2a-0ee2a63462a5_740x714.png)](https://substackcdn.com/image/fetch/$s_!uNkV!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6fa1e9ed-5b12-4623-ac2a-0ee2a63462a5_740x714.png)

_caption:_ Source: ClusterMAX Results Dashboard

[![](https://substackcdn.com/image/fetch/$s_!CNH3!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F321be736-0b73-4b6a-b7ba-ba6fe06c960c_734x772.png)](https://substackcdn.com/image/fetch/$s_!CNH3!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F321be736-0b73-4b6a-b7ba-ba6fe06c960c_734x772.png)

_caption:_ Source: ClusterMAX Results Dashboard

### Inference

We run the InferenceX [AgentX benchmark](https://inferencex.semianalysis.com/agentx) in single node and multinode scenarios with different models to find compute-bound, memory-bound and comms-bound regimes with profiling traces on, treating the InferenceX results as the benchmark performance result to compare to. As with our training tests, this highlights the importance of the various cluster components covered in the microbenchmarks. If a cluster can’t survive NCCL tests, it certainly won’t be able to produce many tokens, and our InferenceX tests show how goodput is lost.

## Phase 3: Reliability

Just because we see solid performance during a benchmark does not mean that the provider can drive solid [goodput](https://newsletter.semianalysis.com/p/how-much-do-gpu-clusters-really-cost), and it certainly doesn’t mean they will provide a nice support experience. So, we test reliability, monitoring and autoremediation in multiple ways.
...
This is our most critical test. Providers where we hear a bunch of customer complaints about reliability generally do not have health checks, monitoring dashboards, and autoremediation in place. Reliability is the #1 most important criteria to many of the biggest customers in the world, as we discussed in great detail in our article “[How Much Do GPU Clusters Really Cost](https://newsletter.semianalysis.com/p/how-much-do-gpu-clusters-really-cost)?”

[![](https://substackcdn.com/image/fetch/$s_!2sN2!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffa331e4d-ca20-4efb-a547-4c4b45f38fd8_923x756.png)](https://substackcdn.com/image/fetch/$s_!2sN2!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffa331e4d-ca20-4efb-a547-4c4b45f38fd8_923x756.png)
...
[![](https://substackcdn.com/image/fetch/$s_!eE5d!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F58068806-a29a-439d-b8a2-a8e071d42102_908x772.png)](https://substackcdn.com/image/fetch/$s_!eE5d!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F58068806-a29a-439d-b8a2-a8e071d42102_908x772.png)
...
The hottest topic in neocloud land over the past few months has been financing. Everyone wants to “follow the money”, which is exactly what we do in our AI Compute, Capital, and Markets Model, which we launched in a [recent article breaking down how NVIDIA’s Backstop Universe](https://newsletter.semianalysis.com/p/nvidias-backstop-universe-heads-i). Below we will discuss a few more hot topics.
...
This topic has died down a little since we went after Dr. Burry [in our article last November](https://newsletter.semianalysis.com/i/178649945/depreciation-schedules-and-the-future-of-gpus-in-azure). Maybe it was all those 6 year contracts people are signing, or those pesky 4-year-old H100s that just won’t drop in price! Who’s to know for sure.
...
As we discussed [in great detail in ClusterMAX 2.0](https://newsletter.semianalysis.com/i/178057384/gb200-nvl72-reliability-and-slas), the difference between operating 8-way H100 HGX servers and GB300 NVL72 rack-scale systems is massive. Providers who cut their teeth installing H100s 3-4 years ago, are now contending with the following:

- Grace CPUs based on ARM (instead of x86 Intel or AMD)
- Blackwell GPUs with sm100/sm103 (with CUDA 13.0+)
- Mandatory direct liquid cooling (DLC)
- High voltage power (130kW+ per rack, via 3phase 408 or 480V power delivery)
- Scale-out networks with 800G CX-8 NICs and 51.2T or 102.4T (800GbE RoCE Spectrum-X) or 115.2T switches (800Gb XDR InfiniBand)
- Scale-up networks with NVLink switches and backplanes at rack-scale, 72-way
- BF-3 or BF-4 DPUs for the frontend (or converged frontend/storage) network
- Multiplanar networks with shuffle boards/shuffle cables
...
The major changes are in the move from 800G CX-8 NICs to 1.6T CX-9 NICs on the scale-out network, and increased power moving from ~130kW to ~200kW per rack, including [800V DC options](https://newsletter.semianalysis.com/p/inside-the-800vdc-revolution-part).

Early demand is more robust than in the Blackwell transition—having partially to do with the fact that [it’s easier to port GB software to VR than it was from Hopper to GB](https://newsletter.semianalysis.com/p/vera-rubin-nvl72-vs-gb200-nvl72-inference)—and we’re hearing from many providers that they are on track to deliver VR earlier than expected. Bring up has been surprisingly smooth, and the physical design seems to be much more mature.
...
- sriov_legacy: a VF via NAD-bound nvidia.com/ and a SriovNetwork NAD, plus RDMA CNI where needed
...
Around the time we started our research for [How Much Do GPU Clusters Really Cost?](https://newsletter.semianalysis.com/p/how-much-do-gpu-clusters-really-cost), we started injecting failures into every cluster we tested. The differences between providers were big. Handling a failure takes two things:

- Identify it happened
- Fix it properly
...
Please contact us at [clustermax@semianalysis.com](mailto:clustermax@semianalysis.com) for more information.

## Security

Since we put out “[Most Neoclouds Suck at Security](https://newsletter.semianalysis.com/p/most-neoclouds-suck-at-security),” we’ve been encouraged by the response. Our friends have been running [our CLI](https://github.com/SemiAnalysisAI/clustermax) on their clusters to find which dusty old packages to replace, and there has generally been increased impetus to treat this issue with the seriousness that it merits.

Still, we think it deserves more scrutiny. As discourse reaches a fever pitch over whether AI will kill everyone, there has been almost no analysis of the concrete means by which it could actually elude control and do harm. [OpenAI](https://openai.com/index/hugging-face-incident-and-the-road-ahead/) and [Anthropic](https://www.anthropic.com/news/investigating-incidents-cybersecurity-evals) are spending gazillions of dollars doing gain-of-function research, some of their infra has been revealed deeply suspect, and yet it has mostly escaped commentary that GPU clusters—the physical hosts that underlie these models—often have nothing like the immune system that you would hope.
...
[![](https://substackcdn.com/image/fetch/$s_!C2Hi!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdcd6b188-48c7-4998-a18f-20a0bd3fc723_1339x1339.png)](https://substackcdn.com/image/fetch/$s_!C2Hi!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdcd6b188-48c7-4998-a18f-20a0bd3fc723_1339x1339.png)
...
> We are actively hiring across Research, Consulting, and Technical Staff. We have multiple openings in our New York and San Francisco offices. Remote work is also acceptable.ClusterMAX Engineer: all levels of experience with Slurm, Kubernetes, and GPUs considered ([full time](https://semianalysis.com/semianalysis-careers/#role-member-of-technical-staff-clustermax))Tokenomics Engineer: all levels of experience with model evals, harnesses, inference endpoints, and RL infrastructure considered ([full time](https://semianalysis.com/semianalysis-careers/#role-member-of-technical-staff-clustermax))Research Analyst - AI Infrastructure and Economics: all levels of experience covering the financials of neoclouds, neolabs, and frontier labs tokenomics considered ([full time](https://semianalysis.com/semianalysis-careers/#role-mts-research-analyst-ai-infrastructure-economics), or [internship](https://semianalysis.com/semianalysis-careers/#role-mts-research-analyst-intern-ai-infrastructure-economics))Technical Consultant: lead engagements from technical strategy to technical due diligence. all levels of experience from consulting and technical backgrounds considered ([full time](https://semianalysis.com/semianalysis-careers/#role-technical-consultant))
...
Nebius’s relationship with Nvidia remains strong, including a [$2B investment in March](https://nebius.com/newsroom/nvidia-and-nebius-partner-to-scale-full-stack-ai-cloud), as Nvidia disclosed a [9.3% overall stake in July](https://finance.yahoo.com/technology/ai/articles/nvidia-reports-9-3-beneficial-134838540.html). Nebius was the first provider to deploy HGX B300s back in December of 2025, and has been [among the first neoclouds in VR NVL72 bring-up](https://blogs.nvidia.com/blog/vera-rubin/), [expecting to begin deployment](https://www.fool.com/earnings/call-transcripts/2026/08/19/nebius-nbis-q2-2026-earnings-call-transcript/) late this year or early next.

Nebius’s buildout continues across a number of sites in the US and Europe as [they recently raised their 2027 year-end contracted power target to 5 GW](https://www.sec.gov/Archives/edgar/data/1513845/000110465926094568/tm2622968d1_ex99-2.htm). In terms of offtakers, Nebius has signed large deals with hyperscalers [Meta](https://nebius.com/newsroom/nebius-signs-new-ai-infrastructure-agreement-with-meta) and [Microsoft](https://nebius.com/newsroom/nebius-announces-multi-billion-dollar-agreement-with-microsoft-for-ai-infrastructure) and smaller ones with [Reflection AI](https://techcrunch.com/2026/07/14/reflection-inks-1b-compute-deal-with-nebius/) and [Palantir](https://nebius.com/newsroom/palantir-and-nebius-partner-to-deliver-a-complete-sovereign-ai-stack-to-palantir-customers), making it one of a few neoclouds with multi-hundred-MW hyperscaler agreements that still regularly competes for much smaller startup contracts. They are the most active of all neoclouds in the short-term cluster market, serving many happy customers. The days of Nebius spooking prospects with their Russian accents are behind them. This is mirrored by its capacity procurement: unlike many of its peers, Nebius has opportunistically snatched up sites in the 5-20 MW range through a broad network of datacenter and software partners.

In terms of the clusters themselves, well, a good cluster is generally boring. On Nebius, burn-ins run without errors; Slurm is topology-aware; the packages we need are on the cluster and generally recent; WAN is good; the orchestration layers are free of footguns. One point of distinction technically between Nebius and everyone else is that Nebius builds and open-sources its preferred SonK flavor, [Soperator](https://github.com/nebius/soperator). (CoreWeave, of course, builds SUNK in house, but it is not open-source.) This round, a Gcore cluster we tested used Soperator, and as did Voltage Park and FPT clusters from previous rounds. Nebius [writes that “the real magic of Soperator lies in how we use ‘jail’ Persistent Volume”](https://nebius.com/blog/posts/soperator-in-open-source-explained): Nebius provides a VirtioFS volume at `jail`, then bind-mounts it at `/`, so you don’t need to worry about pointing your cache to the right directory, or think much about taking your files with you when you `salloc` a node. You’ll see in our writeups of other providers a handful of gnarly issues with managing the storage system on SonK: Slurm and Kubernetes have different philosophies of persistence, and it’s not always straightforward to provide the illusion of bare metal when in fact you’re several layers up, standing on an ephemeral Kubernetes pod. Nebius’s approach makes this stress-free for the operator.

In particular, Nebius provided us a handful of storage tiers on every worker: `/jail` VirtioFS, `/home` NFS, `/mnt/data/` VirtioFS, `/mnt/local-nvme` ext4, and `/mnt/memory` tmpfs, as well as [first-class S3](https://docs.nebius.com/object-storage/). For I/O-heavy jobs, `/mnt/data` is recommended, whereas `/home` suffices for shared code and other data with lower-concurrency access. When we first tested `/mnt/data`, we saw very slow 4 KiB sequential allocating writes, while concurrent directory creation from 128+ ranks sometimes returned `EEXIST` due to inconsistent metadata visibility, killing our jobs. With our feedback on the pathological workloads, Nebius retuned this filesystem, and it proved sturdy and fast. We pushed it around and verified that the errors were resolved; per-client, it outperformed the median, and we could further verify that it scaled to handle demanding workloads across two racks.
...
[![](https://substackcdn.com/image/fetch/$s_!fVHi!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F31c3e010-0c8b-4dba-8b86-4a388335ff60_2048x1208.png)](https://substackcdn.com/image/fetch/$s_!fVHi!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F31c3e010-0c8b-4dba-8b86-4a388335ff60_2048x1208.png)
...
Amidst the strange retreat of Google Brain and DeepMind from the frontier, GCP has been dealmaking like few others. Notable partners include [Palo Alto Networks for $10B](https://finance.yahoo.com/news/google-cloud-lands-deal-palo-130205661.html) and [Thinking Machines Lab for a “multibillion-dollar deal,”](https://techcrunch.com/2026/04/22/exclusive-google-deepens-thinking-machines-lab-ties-with-new-multi-billion-dollar-deal/) along with expansions of its lucrative relationship with AI safety org Anthropic. With acquisitions of [cybersecurity startup Wiz for $32B](https://techcrunch.com/2026/03/11/google-completes-32b-acquisition-of-wiz/) and energy startup [Intersect for $4.75B in cash](https://abc.xyz/investor/news/news-details/2025/Alphabet-Announces-Agreement-to-Acquire-Intersect-to-Advance-U-S--Energy-Innovation-2025-DVIuVDM9wW/default.aspx), Google has been aggressive in expanding its technical capabilities. It also exposes itself to new revenue streams by [ramping TPU sales](https://semianalysis.com/accelerator-hbm-model/) instead of only renting them through GCP, a development we are very keen to track. Its own TPUaaS is still growing, though, thanks to a [$5B deal with Blackstone](https://www.blackstone.com/news/press/blackstone-announces-joint-venture-with-google-to-create-new-tpu-cloud/) that is targeting 500 MW in capacity. Google has gigawatts in the pipeline, and we look forward to continuing to track its continued competition with the other hyperscalers and labs for access to power and permitting.

With a unique position cutting across so many layers of the stack, Google may have more total engineering talent than any company in the world, yet it has a [notably imperfect history](https://killedbygoogle.com/) in supporting innovation. In ClusterMAX 1.0, we noted a myriad of issues with its platform, yet we predicted GCP would reach Gold or Platinum promptly. It has taken until ClusterMAX 3.0 for this to come true, but Google is finally and comfortably among the best managed cluster providers.
...
[![](https://substackcdn.com/image/fetch/$s_!mRfb!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fba8d6bb3-86ab-4dd2-be3e-d310b9718ccb_666x108.png)](https://substackcdn.com/image/fetch/$s_!mRfb!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fba8d6bb3-86ab-4dd2-be3e-d310b9718ccb_666x108.png)[![](https://substackcdn.com/image/fetch/$s_!aX1W!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faba7483b-faa9-4e5a-b52f-6e581ffdd2ca_2048x1241.png)](https://substackcdn.com/image/fetch/$s_!aX1W!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faba7483b-faa9-4e5a-b52f-6e581ffdd2ca_2048x1241.png)
...
[![](https://substackcdn.com/image/fetch/$s_!Mmf0!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F693ad4f9-4ec8-443e-a72c-2ac4f40d6d15_1928x1478.png)](https://substackcdn.com/image/fetch/$s_!Mmf0!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F693ad4f9-4ec8-443e-a72c-2ac4f40d6d15_1928x1478.png)

This could conceivably have been an issue with NCCL itself rather than a problem with our GCP configuration. NCCL’s heuristics [don’t always pick the right protocol and algorithm](https://developer.nvidia.com/blog/understanding-nccl-tuning-to-accelerate-gpu-to-gpu-communication/) for the message size and topology, and some hand-tuning is always expected. However, we have gigabytes of networking data gathered at this point, and we knew to expect better perf. The issue turned out to be simply that we did not have the gIB plugin enabled. This is a set of NCCL plugins Google that ships for improved perf on Google’s RoCE network. As of 26.07, gIB is baked into the NGC PyTorch image, so Google’s customers get the custom stack by default. With gIB installed, we got a better chart with 4.4% higher peak throughput for 16-node all-to-all. (Note that these tests are both with the multi-node NVLink fabric shut off to isolate performance of the scale-out network, which is RoCE in this case.)

[![](https://substackcdn.com/image/fetch/$s_!gXAb!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1bd9c330-467a-42b9-9da6-175f6a9af4a7_1329x1042.png)](https://substackcdn.com/image/fetch/$s_!gXAb!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1bd9c330-467a-42b9-9da6-175f6a9af4a7_1329x1042.png)
...
[![](https://substackcdn.com/image/fetch/$s_!5WTw!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdc7905b0-29a3-4d2b-bc64-bc5547bdb441_1682x1144.png)](https://substackcdn.com/image/fetch/$s_!5WTw!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdc7905b0-29a3-4d2b-bc64-bc5547bdb441_1682x1144.png)

_caption:_ Source: Nvidia
...
As we mentioned in ClusterMAX 2.0, Oracle is in a unique position among hyperscalers in that its growth must come from large contracts. Unlike AWS, Google, and Azure, Oracle does not have any agreements to sell frontier tokens, and unlike Meta and Google, it does not have a non-frontier lab it can hang its hat on. Instead, it continues to cut huge deals involving OpenAI, Meta, and Nvidia, reporting “[the delivery of 850MW additional datacenter capacity](https://s23.q4cdn.com/440135859/files/content_files/1q27-pressrelease-September_FINAL.pdf#page=1)” from June through August, an eye-watering number. We project its relative growth in 2027 to be the largest of the hyperscalers, though from the smallest base.

We tested two Oracle clusters, which we will describe in order. The first was a GB300 NVL72 cluster on Slurm, set on a [multi-planar network](https://blogs.oracle.com/cloud-infrastructure/first-principles-acceleron-multiplanar-networking). This was vanilla Slurm, but due to customer demand, Oracle has Slurm-on-OKE on its roadmap. Once our allocation began, we tried to find our way in through the console, but it proved, like all hyperscaler consoles, a forbidding place.

[![](https://substackcdn.com/image/fetch/$s_!9dpo!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fefe741a9-f74f-4a0b-9c5f-070fbb4e2cf7_2048x1090.png)](https://substackcdn.com/image/fetch/$s_!9dpo!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fefe741a9-f74f-4a0b-9c5f-070fbb4e2cf7_2048x1090.png)
...
[![](https://substackcdn.com/image/fetch/$s_!mwOC!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe34a3ddb-3a0f-4480-be9b-63a10a3775fa_2048x1192.png)](https://substackcdn.com/image/fetch/$s_!mwOC!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe34a3ddb-3a0f-4480-be9b-63a10a3775fa_2048x1192.png)[![](https://substackcdn.com/image/fetch/$s_!NVvZ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe6b17127-debb-47f4-8c8d-510e5e724040_873x473.png)](https://substackcdn.com/image/fetch/$s_!NVvZ!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe6b17127-debb-47f4-8c8d-510e5e724040_873x473.png)
...
[![](https://substackcdn.com/image/fetch/$s_!jdB_!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3a8838cf-5ef3-4634-8a08-87f34daba095_2048x492.png)](https://substackcdn.com/image/fetch/$s_!jdB_!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3a8838cf-5ef3-4634-8a08-87f34daba095_2048x492.png)[![](https://substackcdn.com/image/fetch/$s_!qMzh!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F33c3e134-2403-4583-a918-0074c8acc52e_2048x1174.png)](https://substackcdn.com/image/fetch/$s_!qMzh!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F33c3e134-2403-4583-a918-0074c8acc52e_2048x1174.png)
...
Lambda was most recently in the news for participating in a [$35B Anthropic deal](https://www.reuters.com/technology/anthropic-signs-35-billion-cloud-deal-with-nvidia-backed-lambda-source-says-2026-08-31/) for 350 MW in Nueces County, alongside Hut8 and Nvidia. Before that, they were [rumored to be preparing for a 2027 IPO](https://finance.yahoo.com/technology/ai/articles/ai-cloud-provider-lambda-in-talks-for-3-billion-pre-ipo-round-234205946.html), and they separately raised [$1B](https://lambda.ai/blog/lambda-closes-1-billion-senior-secured-credit-facility), [$926M](https://lambda.ai/blog/lambda-closes-926-million-senior-secured-term-loan-b-facility), and [$1B](https://www.bloomberg.com/news/articles/2026-08-28/nvidia-backed-lambda-inks-1-billion-private-debt-for-chip-deal) in debt for their buildouts. Amidst all their growth, after judging them Silver in ClusterMAX 2.0, we were interested in evaluating Lambda’s clusters this time around.

Onboarding began with a nice deck and PDF explaining what to expect on the cluster, and access was sorted out promptly.

[![](https://substackcdn.com/image/fetch/$s_!XWJ0!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd5aecaed-0d08-4c63-8b24-f1058479b4dd_1011x449.png)](https://substackcdn.com/image/fetch/$s_!XWJ0!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd5aecaed-0d08-4c63-8b24-f1058479b4dd_1011x449.png)

[We criticized Lambda in ClusterMAX 2.0 for their reliability](https://newsletter.semianalysis.com/i/178057384/lambda); this round of testing, it was one of Lambda’s points of emphasis. Their passive health checks cover the relevant conditions and ultimately autoremediated three errors we simulated during testing. Two synthetic XIDs were autoremediated in less than 15 minutes, and there were connected dashboards to monitor node health. Our test that triggered a genuine XID 79 by resetting the PCIe secondary bus reset brought the node into `NotReady` with no `GpuXid`, no cordon, and no monitoring visibility on the Kubernetes layer, but it ultimately rejoined the fleet after 2 hours. Our node-reboot tests on the Kubernetes layer also completed without incident.

[![](https://substackcdn.com/image/fetch/$s_!f_OD!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F770c1ebb-c945-4e86-8ff8-cd1c0af7f664_2048x1174.png)](https://substackcdn.com/image/fetch/$s_!f_OD!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F770c1ebb-c945-4e86-8ff8-cd1c0af7f664_2048x1174.png)
...
During testing, we were not allowed to have our own Azure accounts, so we had to use the cluster under the user of one of Azure’s engineers, which prevented us from poking around the console and experiencing the authentic onboarding experience. Our GPUs were set to be in Virginia, but thanks to some obscure internal decree, we were not allowed to have a control plane there. Instead, our control plane ran in San Antonio, Texas. Access required setting up a VPN, which worked after a bit (see: literally 3 weeks) of back and forth. Pasting was disabled on the bastion, so to run our tests, we had to manually type in our GitHub and HuggingFace tokens. Like, literally type them in one character at a time. We got them right first try though, nbd [😮‍💨](https://emojipedia.org/face-exhaling).
...
[![](https://substackcdn.com/image/fetch/$s_!E2Di!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F635db7a9-5287-4c8b-b77e-827a2ccea9f9_515x394.png)](https://substackcdn.com/image/fetch/$s_!E2Di!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F635db7a9-5287-4c8b-b77e-827a2ccea9f9_515x394.png)

_caption:_ Source: a typical Azure experience
...
Due to the account issue, we could not see our Kubernetes dash by default. Instead, Azure’s engineering team cooked up a custom dashboard setup for us, and it was extremely detailed—a solid triumph over the bureaucratic straitjacket. We want to shoutout our friend Xu Xue for this one, as we are quite certain that he went way above and beyond the call of duty to build this out for us, but wouldn’t admit it. His curated dashboard is open sourced [here](https://github.com/xuexu6666/aks/tree/main/gb300/vanillaarm64/clustermax#curated-dashboard-folder--azure-kubernetes-service-monitoring-gb300), a great resource for anyone building Grafana dashboards to monitor Nvidia GPU clusters from scratch.

[![](https://substackcdn.com/image/fetch/$s_!t1Fk!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc233643e-91ca-46e4-bd17-5335a920b937_2048x1088.png)](https://substackcdn.com/image/fetch/$s_!t1Fk!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc233643e-91ca-46e4-bd17-5335a920b937_2048x1088.png)

[Satya once said](https://www.dwarkesh.com/p/satya-nadella-2) “we want to build out Azure as being fantastic for the long tail of the workloads,” and that Microsoft is “not in the business of just doing five contracts with five customers being their bare-metal service.” Yet it is exceedingly rare to come across a VC-backed lab that uses Azure for training and inference. “Five customers for bare-metal service” is overstating it. Really, it’s two: OpenAI and MAI. Soon to be three, with Anthropic diversifying.

Azure’s most interesting asset is that it can serve OpenAI’s models and keep 100% of the revenue. They still have full access to all of OpenAI’s IP. Yet Azure can separately boast of large bare-metal deals with OpenAI, as well as an increasingly lucrative relationship with Anthropic. This is an incredibly strong position to be in. If only for [the pause](https://newsletter.semianalysis.com/i/178649945/microsoft-and-openai-in-2023-25-from-all-in-on-ai-to-the-big-pause).
...
One of Nvidia’s favorite up-and-comers, and our favorite in Asia-Pacific, Firmus [announced in August a $2B funding round](https://firmus.co/newsroom/firmus-announces-fully-subscribed-usdusd2-billion-strategic-equity-investment-to-accelerate-nvidia-ai-factory-expansion-across-australia-and-asia-pacific) at $10.5B post-money for expansion throughout Australia, Malaysia, and Indonesia, following a [$505M round at $5.5B](https://firmus.co/newsroom/firmus-raises-usdusd505-million-in-strategic-equity-investment-led-by-coatue) just 4 months before. Firmus also [raised a $10B debt facility](https://firmus.co/newsroom/firmus-signs-multi-year-agreement-with-global-hyperscale-customer-at-project-southgate) in March for its Project Southgate buildout in Melbourne and Tasmania. Just last week, [it disclosed 900 MW in total contracted capacity and announced OpenAI as an anchor tenant in its Malaysian expansions](https://firmus.co/newsroom/firmus-surpasses-900-mw-contracted-capacity-adds-openai-as-anchor-customer-and-expands-into-malaysia). All in all, Firmus has disclosed 18,400 GB300 GPUs in the deployment process today and 36,800 later this year in Tasmania, with multiple GWs and tens of thousands of VR in the pipeline.
...
[![](https://substackcdn.com/image/fetch/$s_!M9JN!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0cf70335-6a7f-4096-af05-91345833c99d_1762x1020.png)](https://substackcdn.com/image/fetch/$s_!M9JN!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0cf70335-6a7f-4096-af05-91345833c99d_1762x1020.png)

Being an AMD-only cloud, TensorWave is fighting an uphill battle dealing with AMD’s software stack, which, [despite significant recent progress](https://newsletter.semianalysis.com/p/can-amd-break-the-cuda-moat-amd-advancing), [still lies well behind Nvidia’s](https://inferencex.semianalysis.com/). We saw this on our TensorWave cluster on RCCL microbenchmarks, with all-gather and all-to-all hanging at 32 KiB even using TensorWave’s binaries and recipes. Other collectives showed uneven scaling and poor throughput at certain message sizes. [Editorial comment: RCCL? More like Rick L!] In general, it can be said that the AMD networking stack lacks the community support that Nvidia tooling offers. The same goes, of course, on the hardware side. More important than microbenchmarks, we see in practice that the GB300 NVL72 systems have the most demand across the industry from labs: their performance is so superior that, even accounting for their higher prices, they often offer the best perf per dollar as well. AMD’s rackscale answer, the [MI455X Helios](https://tensorwave.com/blog/tensorwave-powers-frontier-ai-growth-for-cloud-customers-with-amd-helios-rackscale-solution), is still [ramping up production](https://newsletter.semianalysis.com/p/can-amd-break-the-cuda-moat-amd-advancing), and is certainly not yet on offer by TensorWave. Thus, TensorWave’s place in the rankings depends not only on its internal improvements, but on AMD’s ongoing work to close the gap relative to Nvidia.
...
[![](https://substackcdn.com/image/fetch/$s_!eKJt!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc7ef5150-eafb-4b86-8107-1747f6834a4a_1246x228.png)](https://substackcdn.com/image/fetch/$s_!eKJt!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc7ef5150-eafb-4b86-8107-1747f6834a4a_1246x228.png)
...
[![](https://substackcdn.com/image/fetch/$s_!dP5B!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1c865a25-bf2c-4979-829d-174de670437a_2048x1177.png)](https://substackcdn.com/image/fetch/$s_!dP5B!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1c865a25-bf2c-4979-829d-174de670437a_2048x1177.png)
...
[![](https://substackcdn.com/image/fetch/$s_!tiD-!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4a311905-19d3-45bd-9d3c-3aa8b2e1fb03_1246x718.png)](https://substackcdn.com/image/fetch/$s_!tiD-!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4a311905-19d3-45bd-9d3c-3aa8b2e1fb03_1246x718.png)

Overall, TensorWave is the leading AMD-exclusive neocloud, providing a comparable (and sometimes better) experience on AMD GPUs than hyperscalers like Oracle and Microsoft. And they are not stopping. TensorWave has [entered into an agreement with Fermi](https://tensorwave.com/blog/fermi-announces-binding-lease-agreement-with-tensorwave) for 222 MW in the Texas panhandle with expansion rights up to 650 MW, contingent upon Fermi securing project financing. It has a tailwind with a [$350M June Series B](https://tensorwave.com/blog/tensorwave-raises-350-million-series-b-at-1-55b-valuation-to-expand-global-amd-powered-ai-infrastructure), leaving it at $1.55B post-money, and is currently working on large deals with hyperscalers. With both [OpenAI](https://openai.com/index/openai-amd-strategic-partnership/) and [Anthropic](https://ir.amd.com/news-events/press-releases/detail/1292/amd-and-anthropic-announce-strategic-partnership-to-deploy-up-to-2-gigawatts-of-amd-instinct-mi450-series-gpus) announcing strategic partnerships with AMD for the MI450 generation, we expect that TensorWave is set to benefit, and AMD-exclusive neoclouds may be able to break into the Gold tier. We look forward to testing TensorWave’s MI455X Helios once it is available.

### GMI

GMI is a neocloud headquartered in Mountain View with roots in Taiwan. With a [$500M Nvidia deal announced last November](https://www.gmicloud.ai/en/blog/gmi-cloud-brings-taiwans-first-ai-factory) and [$12B more this March](https://www.gmicloud.ai/en/blog/gmi-cloud-announces-1gw-sovereign-ai-infrastructure-in-japan-accelerated-by-nvidia-vera-rubin-nvl72-tm), hundreds of GB300 racks in the pipeline, and plans for VR down the line, they are keeping on the frontier in terms of hardware. Recently, they have also been growing their fleet by making deals with smaller neoclouds and reselling the compute to their established customer base, which offers an attractive cashflow profile because it does not require up-front capital outlay. After judging them the “top Bronze neocloud” in [ClusterMAX 2.0](https://newsletter.semianalysis.com/p/clustermax-20-the-industry-standard), we were interested to test the progress of their managed clusters.
...
[![](https://substackcdn.com/image/fetch/$s_!xYqi!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa43db568-8572-4364-bf82-2a54b367c68a_2031x1230.png)](https://substackcdn.com/image/fetch/$s_!xYqi!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa43db568-8572-4364-bf82-2a54b367c68a_2031x1230.png)
...
[![](https://substackcdn.com/image/fetch/$s_!CDJA!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F870e9761-ea42-466a-a72a-1b1763e21d5f_1700x1650.png)](https://substackcdn.com/image/fetch/$s_!CDJA!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F870e9761-ea42-466a-a72a-1b1763e21d5f_1700x1650.png)

_caption:_ Source: Intern (I forget his name)

(Caveat lector: anyone not interested in the minutiae of AWS’s GPU offerings should skip this ¶.) [SageMaker](https://docs.aws.amazon.com/sagemaker/latest/dg/how-it-works-mlconcepts.html) is AWS’s fully managed platform meant for minimal maintenance. If you don’t want to handle any infrastructure, it offers [serverless model customization](https://docs.aws.amazon.com/sagemaker/latest/dg/customize-model.html) and [data science environments](https://aws.amazon.com/sagemaker/unified-studio/) that abstract away the underlying compute. At the next level up is the [SageMaker HyperPod](https://aws.amazon.com/sagemaker/ai/hyperpod/) line, which supports both [Slurm](https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-hyperpod-slurm.html) and [EKS](https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-hyperpod-eks.html). The HyperPod line offers many conveniences like [health checks](https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-hyperpod-resiliency-slurm-deep-health-checks.html), [autoremediation](https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-hyperpod-resiliency-slurm-auto-resume.html), [dashboards](https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-hyperpod-cluster-observability-slurm.html), and workload-level features like [checkpointless training](https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-eks-checkpointless.html) out of the box for users who want to preserve their `ssh` or `kubectl` access. If you want infrastructure abstracted away but want to handle the ML stack yourself, you can leave the SageMaker umbrella and choose [EKS Auto Mode](https://docs.aws.amazon.com/eks/latest/userguide/automode.html), which takes care of node provisioning, autoscaling, OS patching, and node repair. EKS Auto Mode is a wrapper on top of “managed EC2 instances,” but these are not actual EC2 instances in the sense that they do not show up in the EC2 console and do not provide the same level of customizability as ordinary EC2 instances. In EKS Auto Mode, users do not have access to the control plane, and they must allow AWS to recycle their workers [every 21 days for security](https://docs.aws.amazon.com/eks/latest/userguide/automode.html#:~:text=21%20days%20%28which%20you%20can%20reduce%29). Finally, for even greater customizability, there is [EKS + Karpenter](https://docs.aws.amazon.com/eks/latest/best-practices/karpenter.html), which allows the user to manage autoscaling themselves with the open-source tool [Karpenter](https://karpenter.sh/).

Despite Amazon’s reputation as “[customer-obessed](https://www.amazon.jobs/content/en/our-workplace/leadership-principles),” it is clear that this novel-length GPU menu is an example of the adage “[you ship your org chart](https://en.wikipedia.org/wiki/Conway%27s_law)” rather than a reflection of genuine demand segmentation. And the bureaucratic frustrations hardly end once you’ve ordered your cluster. This is a criticism of the organization rather than of any team in particular—AWS has shades of the [3rd-Century Roman Empire](https://en.wikipedia.org/wiki/Crisis_of_the_Third_Century). To improve its standing in the next round of ClusterMAX testing, we recommend AWS choose another empire and/or time period for reference.
...
[![](https://substackcdn.com/image/fetch/$s_!o3AI!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F96cb228c-6606-4934-9672-72ef4487dd7f_1700x1560.png)](https://substackcdn.com/image/fetch/$s_!o3AI!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F96cb228c-6606-4934-9672-72ef4487dd7f_1700x1560.png)

_caption:_ Source: Ibid.
...
A basic point of distinction between the AWS clusters we tested and their peer B200 clusters is that AWS uses Elastic Fabric Adapter (EFA), its proprietary scale-out fabric. In our testing, peak EFA throughput was strong. On a four-node 32-GPU all-to-all [NCCL](https://en.wikipedia.org/wiki/Settler_colonialism) test over EFA on B200 we measured 59.44 GB/s busbw at 16 GiB message size, which works out to about 92% of scale-out line rate given the proportion of traffic that crosses the node boundary. On other networking tests with other traffic patterns and launching mechanisms, as long as message size was large enough, throughput was among the best B200 clusters. However, EFA consistently demonstrated worse latency than well tuned InfiniBand comps. For example, when the message size was reduced to 64 KiB, the same four-node 32-GPU all-to-all NCCL test took 85.26µs over EFA and under 50µs on InfiniBand peers; this delta of 30-40% between EFA and InfiniBand was consistent across small-message tests, which are latency-dominated. Although this may seem like a nitpick, scale-out latency is a critical metric for modern [expert-parallel](https://inferencex.semianalysis.com/glossary/expert-parallelism) workloads, which frequently send small token vectors across the node boundary. This 64 KiB NCCL test, for example, is similar to the expert routing step of models like Kimi K3 and DeepSeek V4. Our findings are corroborated by an [excellent Perplexity technical blog post about optimizing EFA](https://research.perplexity.ai/articles/enabling-trillion-parameter-models-on-aws-efa), which reported similar results: EFA demonstrates satisfactory peak throughput but pays a latency penalty of 20µs or so on “the message sizes exchanged during MoE dispatch and combine.” (Note that this Perplexity post compares EFA to ConnectX-7 NICs whereas we tested ConnectX-8, but the nameplate throughput of the two generations is identical.) It’s not a good sign when Perplexity’s cracked engineers are writing painstakingly detailed blog posts about how to “enable” basic functionality on your custom network stack.

[![](https://substackcdn.com/image/fetch/$s_!RTQu!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8af3c70d-f9ae-43c4-afb5-98722cd154cb_2048x1253.png)](https://substackcdn.com/image/fetch/$s_!RTQu!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8af3c70d-f9ae-43c4-afb5-98722cd154cb_2048x1253.png)

_caption:_ All-reduce tests on EFA. Note that message size must double many times before time to completion changes much; this is because at small sizes, it is latency, rather than line rate, that defines performance..

EFA still requires extra setup for expert-parallel inference in upstream vLLM and SGLang. AWS reports successful vLLM deployments, but users must install EFA userspace libraries and build the relevant communication components with EFA support. Depending on the workload, these include DeepEP, NIXL, or Mooncake Store. [AWS’s DeepEP fork](https://github.com/amazon-contributing/DeepEP) supports EFA through NCCL GIN. [DeepEP V2](https://github.com/deepseek-ai/DeepEP) uses NCCL GIN, while its NVSHMEM-based V1 path is now documented as legacy. Upstream integration and default container packaging still require work. NCCL EP is another route under development; the linked vLLM integration remains a [draft PR](https://github.com/vllm-project/vllm/pull/56241). In general, EFA is not a priority for frontier communications libraries, and users must wait weeks or months for what support they do get.
...
[![](https://substackcdn.com/image/fetch/$s_!JRNV!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbf42d75a-3a29-49ae-b581-025db99bce52_1244x252.png)](https://substackcdn.com/image/fetch/$s_!JRNV!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbf42d75a-3a29-49ae-b581-025db99bce52_1244x252.png)
...
[![](https://substackcdn.com/image/fetch/$s_!j7ks!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd91b500f-d3b9-4fd0-a3a0-77a6d644b532_2048x1218.png)](https://substackcdn.com/image/fetch/$s_!j7ks!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd91b500f-d3b9-4fd0-a3a0-77a6d644b532_2048x1218.png)

_caption:_ Source: Provisioning purgatory.
...
Powered on and wired up, storage perf was mixed. The provided [FSx stack struggled significantly with ordinary buffered I/O](https://github.com/SemiAnalysisAI/ClusterMAX-internal/blob/d039ae43c09bc20e32cfea67469f80069e90d2a8/runs/aws-eks-karpenter-b200/20260729-094037/tests/fio/fio.values.json#L34), reaching 9.2s in p99 sequential read latency on fio testing, compared to 312ms on the same metric with buffering disabled. Greater latency on the buffered setting is expected, but this is a pathological delta.
...
Severity=FatalThis would again have recycled a healthy node if we did not manually pin NodeRepair=false to keep overzealous garbage collection from blocking our work. Finally, as our testing came to a close, Karpenter tore down our B200 cluster 39 minutes before the EndDate, force-evicting a 4-node MPIJob in progress. We have gone into such detail here because these bugs are almost unbelievably elementary for the world’s largest cloud. Perhaps the single painfree part of the AWS lifecycle was Karpenter scale-up and scale-down, which completed in minutes with no errors. However, GPU capacity must be secured in large blocks and far in advance, so snappy autoscaling with Karpenter is a meaningless feature.

Despite the many problems with their product, AWS’s specialists and engineers were intelligent and responsive in our interactions with them. They were eager to show what they had improved, sought out feedback on documentation, circled back to rectify errors in testing, and even built a nice, forward-looking [MCP server](https://awslabs.github.io/mcp/servers/sagemaker-ai-mcp-server) whose skills we plundered for our own codebase. AWS’s issues lie in its organizational structure. The number of basic issues that have slipped through the cracks is astonishing in an organization with AWS’s resources.

In February, AWS [announced the expansion of its deal with OpenAI by $100B](https://press.aboutamazon.com/2026/2/openai-and-amazon-announce-strategic-partnership); in 2Q26, it [posted 37% growth in net sales YoY](https://www.sec.gov/Archives/edgar/data/1018724/000101872426000024/amzn-20260630xex991.htm); [its Trainium business has hit $25B in ARR with triple-digit YoY growth](https://www.sec.gov/Archives/edgar/data/1018724/000101872426000024/amzn-20260630xex991.htm); [its Anthropic investment is appreciating to the tune of tens of billions per year](https://www.sec.gov/Archives/edgar/data/1018724/000101872426000024/amzn-20260630xex991.htm); Bedrock [continues to make bed-rocking margins on bed-rocking income](https://newsletter.semianalysis.com/p/anthropic-growth-and-bedrock-mix).
...
[![](https://substackcdn.com/image/fetch/$s_!HibB!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F45cb65a8-b84d-4b13-99cb-24afea4c0cce_2024x286.png)](https://substackcdn.com/image/fetch/$s_!HibB!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F45cb65a8-b84d-4b13-99cb-24afea4c0cce_2024x286.png)
...
[![](https://substackcdn.com/image/fetch/$s_!DxFL!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4ede5496-e7a8-469c-96f7-97530bc48a7e_2048x126.png)](https://substackcdn.com/image/fetch/$s_!DxFL!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4ede5496-e7a8-469c-96f7-97530bc48a7e_2048x126.png)
...
[![](https://substackcdn.com/image/fetch/$s_!YrbA!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0fe89460-79f5-4eeb-bd38-db18f40971f6_2048x1214.png)](https://substackcdn.com/image/fetch/$s_!YrbA!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0fe89460-79f5-4eeb-bd38-db18f40971f6_2048x1214.png)
...
[![](https://substackcdn.com/image/fetch/$s_!Md-Q!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F49a763f9-8c8b-44cd-8b93-ce1bda77006b_2048x1149.png)](https://substackcdn.com/image/fetch/$s_!Md-Q!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F49a763f9-8c8b-44cd-8b93-ce1bda77006b_2048x1149.png)
...
[![](https://substackcdn.com/image/fetch/$s_!M6Z-!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdf12c9e5-7529-4849-897c-d4198170d523_1226x667.png)](https://substackcdn.com/image/fetch/$s_!M6Z-!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdf12c9e5-7529-4849-897c-d4198170d523_1226x667.png)

_caption:_ Source: PoV you are a SemiAnalysis intern who dropped Japanese after two classes trying to locate a Grafana dashboard
...
[![](https://substackcdn.com/image/fetch/$s_!Ne4g!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F91ea0e60-f11b-4708-ae48-23cf601addd6_1111x913.png)](https://substackcdn.com/image/fetch/$s_!Ne4g!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F91ea0e60-f11b-4708-ae48-23cf601addd6_1111x913.png)

_caption:_ Source: Attempting to access our Grafana dashboard
...
[![](https://substackcdn.com/image/fetch/$s_!lLSi!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0fd9aa99-91e9-423f-8096-cf04312f20c9_1312x888.png)](https://substackcdn.com/image/fetch/$s_!lLSi!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0fd9aa99-91e9-423f-8096-cf04312f20c9_1312x888.png)

_caption:_ Source: Our Grafana Dashboard on GMO!
...
[![](https://substackcdn.com/image/fetch/$s_!5lYj!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1eba537c-4823-4331-9aca-a3f6d9937dd0_2048x1180.png)](https://substackcdn.com/image/fetch/$s_!5lYj!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1eba537c-4823-4331-9aca-a3f6d9937dd0_2048x1180.png)
...
[![](https://substackcdn.com/image/fetch/$s_!MCOI!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa56ff15e-9317-41f5-ac49-5bc36feb1a2c_1318x1213.png)](https://substackcdn.com/image/fetch/$s_!MCOI!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa56ff15e-9317-41f5-ac49-5bc36feb1a2c_1318x1213.png)[![](https://substackcdn.com/image/fetch/$s_!tRNF!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F45655420-db56-4293-a8d0-80a50c59c73a_2048x1177.png)](https://substackcdn.com/image/fetch/$s_!tRNF!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F45655420-db56-4293-a8d0-80a50c59c73a_2048x1177.png)
...
[![](https://substackcdn.com/image/fetch/$s_!gYJg!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F22583e07-2129-4410-bcfc-c0dcf855b317_1500x139.png)](https://substackcdn.com/image/fetch/$s_!gYJg!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F22583e07-2129-4410-bcfc-c0dcf855b317_1500x139.png)
...
[![](https://substackcdn.com/image/fetch/$s_!b0YF!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe9d03267-f400-43ca-88a6-32280b0f55e7_1716x227.png)](https://substackcdn.com/image/fetch/$s_!b0YF!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe9d03267-f400-43ca-88a6-32280b0f55e7_1716x227.png)
...
[![](https://substackcdn.com/image/fetch/$s_!19To!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6d454aea-e52e-44f2-8250-0c8b0ad86720_2048x874.png)](https://substackcdn.com/image/fetch/$s_!19To!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6d454aea-e52e-44f2-8250-0c8b0ad86720_2048x874.png)

Together’s health checks did work correctly in some instances, showing progress since [ClusterMAX 2.0](https://newsletter.semianalysis.com/p/clustermax-20-the-industry-standard). When we triggered a PCIe secondary-bus reset on the Slurm cluster, the node was drained in 67s, and an automatic node replacement completed in 35m7s without manual intervention. A synthetic error also cordoned a node on the Kubernetes layer and correctly did not trigger autoremediation because we had `Auto Repair` turned off.
...
In the eight months and change since we published that paragraph, Crusoe has had its fair share of wins. Its valuation has grown from around [$10B](https://www.globenewswire.com/news-release/2025/10/24/3172932/0/en/Crusoe-the-AI-Factory-Company-Raising-1-375-Billion-at-a-Valuation-Above-10-Billion-to-Power-the-Future-of-AI-Infrastructure.html) to [$30.9B](https://www.crusoe.ai/resources/newsroom/crusoe-announces-series-f-funding), it has announced [900MW](https://www.crusoe.ai/resources/newsroom/crusoe-announces-new-900-mw-ai-factory-campus-in-abilene-texas-to-support-microsoft-ai-infrastructure) and [1.0GW](https://www.crusoe.ai/resources/newsroom/crusoe-and-lancium-announce-1-gigawatt-ai-data-center-campus-in-childress-texas) campuses in Texas and [many more elsewhere](https://semianalysis.com/datacenter-industry-model/), and it remains an innovator in the [wild wild west of datacenter construction](https://newsletter.semianalysis.com/p/the-wild-wild-west-of-lego-datacenters). They have the largest real pipeline of any datacenter builder.
...
We emphasize health checks in our [expectations](https://www.clustermax.ai/expectations) and our write-ups, but genuine hardware failures are rare in testing because our ClusterMAX allocations are too small and short-lived. Crusoe bucks this trend. On an H100 cluster we had in May to test AutoClusters, we saw an impressive barrage of [XID](https://docs.nvidia.com/deploy/xid-errors/analyzing-xid-catalog.html)s—more real errors on one cluster over five days than we saw in the rest of testing combined.

[![](https://substackcdn.com/image/fetch/$s_!j3M8!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa329b23f-21d8-4161-8d1d-f6773c4f7648_710x708.png)](https://substackcdn.com/image/fetch/$s_!j3M8!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa329b23f-21d8-4161-8d1d-f6773c4f7648_710x708.png)
...
[![](https://substackcdn.com/image/fetch/$s_!sbUf!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5fb352f0-7454-46a2-a664-06b4b3475be4_1906x717.png)](https://substackcdn.com/image/fetch/$s_!sbUf!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5fb352f0-7454-46a2-a664-06b4b3475be4_1906x717.png)
...
[![](https://substackcdn.com/image/fetch/$s_!ADwB!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F43394dd5-0859-4fda-995d-ebce78b6608d_2048x770.png)](https://substackcdn.com/image/fetch/$s_!ADwB!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F43394dd5-0859-4fda-995d-ebce78b6608d_2048x770.png)

Nor are these software-version criticisms merely academic. The Linux kernel that our B300 cluster ran, `5.15.0-185-generic`, was earlier than a Linux patch series called “[writeback: Avoid lockups when switching inodes](https://github.com/torvalds/linux/commit/9426414f0d42f824892ecd4dccfebf8987084a41).” The particular problem that our kernel experienced is well explained by the description of commit `[e1b849c](https://github.com/torvalds/linux/commit/e1b849cfa6b61f1c866a908c9e8dd9b5aaab820b)`, which fixed it for upstream kernels:```There can be multiple inode switch works that are trying to switch inodes to / from the same wb. This can happen in particular if some cgroup exits which owns many (thousands) inodes and we need to switch them all. In this case several inode_switch_wbs_work_fn() instances will be just spinning on the same wb->list_lock while only one of them makes forward progress. This wastes CPU cycles and quickly leads to softlockup reports and unusable system.
...
[![](https://substackcdn.com/image/fetch/$s_!FtAg!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F02cee8f4-3296-49c3-978f-5731e80353c2_600x1166.png)](https://substackcdn.com/image/fetch/$s_!FtAg!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F02cee8f4-3296-49c3-978f-5731e80353c2_600x1166.png)

By the end of our testing, this kernel was not merely old and unperformant: it was officially marked a security vulnerability by [CVE-2026-64378](https://ubuntu.com/security/CVE-2026-64378), which exploited the buggy writeback behavior, published on July 25 with severity 7.8; [a separate 7.8 for this kernel](https://ubuntu.com/security/CVE-2026-64531) was posted on July 27. Thus, we added the Linux kernel to our collection of Crusoe software exposed to CVEs. Crusoe has informed us that they will be upgrading to a 6-major Linux kernel, a necessary patch.

[![](https://substackcdn.com/image/fetch/$s_!Ppy0!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc39e3841-11dc-4862-a7a8-6352c494c1d0_2048x1470.png)](https://substackcdn.com/image/fetch/$s_!Ppy0!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc39e3841-11dc-4862-a7a8-6352c494c1d0_2048x1470.png)

_caption:_ Source: A Crusoe job posting on August 13, 2026
...
[![](https://substackcdn.com/image/fetch/$s_!Vx1X!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F858e75c1-c96e-4877-8263-21d9a60bda07_2030x810.png)](https://substackcdn.com/image/fetch/$s_!Vx1X!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F858e75c1-c96e-4877-8263-21d9a60bda07_2030x810.png)
...
[![](https://substackcdn.com/image/fetch/$s_!Mp20!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffd0ebfbf-f058-4e7f-b3c8-3b99064127c2_2031x141.png)](https://substackcdn.com/image/fetch/$s_!Mp20!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffd0ebfbf-f058-4e7f-b3c8-3b99064127c2_2031x141.png)

Does a CVE from November of 2025 count as “historical baggage”?

In all seriousness, this is a problem of priorities, a problem of bureaucracy run amok. We are not sure what to make of job postings like the above one for a senior Linux kernel engineer. Literally, we’re just asking everyone to keep things up to date. You don’t need to hire Linus to understand why this makes sense. So while it’s cool to see Crusoe flexing its muscles and paying top dollar for a good person, it’s not a lack of people or funding or technical skill that has brought Crusoe here in the first place. Our complaints focus on the most basic issues possible, not the [Slinky configuration](https://www.crusoe.ai/resources/blog/slurm-on-crusoe-managed-kubernetes-how-we-built-managed-gpu-training-infrastructure)or [console](https://www.crusoe.ai/cloud) or [CLI](https://docs.crusoecloud.com/installing-the-cli/) that no doubt take up much more engineering time and that we enjoy using.
...
Still, in the managed clusters business, [TCO comes down to goodput, and goodput comes down to reliability](https://newsletter.semianalysis.com/p/how-much-do-gpu-clusters-really-cost), and Crusoe’s clusters are exceptionally unreliable.

Crusoe comes in towards the bottom of our Bronze category for this round.

### Prime Intellect

Prime Intellect [closed a $130M Series A this July](https://www.primeintellect.ai/blog/series-a) at a [$1B valuation](https://techcrunch.com/2026/07/08/prime-intellect-raises-130m-series-a-to-help-enterprises-build-their-own-ai-agents/), disclosing $100M of “annualized revenue run rate across compute, RL and post-training, sandboxes, inference, environments, and evaluations.”
...
[![](https://substackcdn.com/image/fetch/$s_!mNM9!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F474ff935-9589-410b-a578-22f98d257375_2048x1154.png)](https://substackcdn.com/image/fetch/$s_!mNM9!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F474ff935-9589-410b-a578-22f98d257375_2048x1154.png)
...
[![](https://substackcdn.com/image/fetch/$s_!_I5c!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4736b265-c5f7-4f4a-b287-4dfddef97232_2048x842.png)](https://substackcdn.com/image/fetch/$s_!_I5c!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4736b265-c5f7-4f4a-b287-4dfddef97232_2048x842.png)
...
This marks the first round of testing that we have been able to get the full DigitalOcean developer experience. [Marketing itself](https://www.sec.gov/Archives/edgar/data/1582961/000158296126000045/a2026-q1dopressrelease.htm) as “the first cloud built end-to-end for the inference and agentic era,” DigitalOcean distinguishes itself from “bare-metal focused neo-clouds and inference wrappers that lack cloud platforms.” In fewer words: DigitalOcean sells, among other things, managed clusters.
...
DigitalOcean [will be adding 60 MW of capacity throughout 2027](https://www.sec.gov/Archives/edgar/data/1582961/000158296126000045/a2026-q1dopressrelease.htm), and, aside from its managed K8s, it has an interesting selection of GPU services like [Droplets](https://www.sec.gov/Archives/edgar/data/1582961/000158296126000045/a2026-q1dopressrelease.htm) and [bare-metal Hopper and MI300X](https://www.digitalocean.com/products/bare-metal-gpus) that fall outside the scope of ClusterMAX testing. But no plans for GB’s or VR’s from what we can see at this point. We look forward to the team continuing to improve its managed Kubernetes service the next time we test.

### Hyperstack

Hyperstack, under parent NexGen Cloud, is a UK-based neocloud that [advertises Kubernetes clusters in the US, Canada, and Norway](https://docs.hyperstack.cloud/llms.txt). It recently [raised $45M at a $354M valuation](https://www.nexgencloud.com/news/nexgen-cloud-secures-45-million-in-series-a-funding-to-expand-sovereign-ai-infrastructure-in-europe) with plans for many AI new products for “full-cycle development.” [As it announced a $34M debt facility to build out a B200 fleet](https://www.nexgencloud.com/news/usd.ai-provides-34m-facility-to-finance-nexgen-clouds-gpu-deployment-in-sweden), it also disclosed plans to deploy 4,500 B300s later this year and for an additional 56 MW online in 2027.
...
[![](https://substackcdn.com/image/fetch/$s_!FjJi!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa7211d5c-b5ef-44b1-a9f5-e99495125b2a_961x486.png)](https://substackcdn.com/image/fetch/$s_!FjJi!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa7211d5c-b5ef-44b1-a9f5-e99495125b2a_961x486.png)
...
Vultr advertises itself as “[the world’s largest privately-held cloud infrastructure company](https://www.businesswire.com/news/home/20260708517182/en/Vultr-and-SUSE-Launch-Validated-Full-Stack-NVIDIA-Enterprise-AI-Platform-to-Accelerate-Production-Deployments),” which they are not, and “[the world’s largest privately held hyperscaler](https://www.hpe.com/us/en/newsroom/press-release/2026/06/vultr-selects-hpe-and-nvidia-for-next-generation-ai-infrastructure-for-cloud-scale-data-centers.html),” which they wouldn’t be even if they were. Still, they are a relevant player in neocloud land, with modern GB300s and MI355X including a claimed [50 MW AMD site](https://www.businesswire.com/news/home/20251202285088/en/Vultr-and-AMD-Expand-Collaboration-to-Drive-Global-AI-Innovation-and-Scale) in Ohio. In [ClusterMAX 2.0](https://newsletter.semianalysis.com/p/clustermax-20-the-industry-standard), Vultr’s cluster was delivered with a handful of basic errors. Unfortunately, the pattern is the same almost a year later.
...
Vessl is a new Korean neocloud who fancies itself a “multi cloud orchestrator” rather than a broker, buying bare metal long-term and providing a management layer with SLAs on top. They [claim 5,000 GPUs currently in operation](https://vessl.ai/ko/blog/vessl-b200-ai-factory) and have an ambitious target of 100 MW by the end of 2027. [An old Vessl BizOps job posting](https://kgsa.net/?page_id=29&mod=document&uid=8667) says to expect “Speed. We MUST move fast, learn fast, and iterate constantly,” demanding “[a minimum of 60 hours per week](https://www.linkedin.com/posts/the-concept-of-80000-hours-career-consulting-share-7471245601628696577-HlPU/).”
...
[![](https://substackcdn.com/image/fetch/$s_!lFOI!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6f043a94-7c2c-4c37-9d56-b627138a60b8_1744x238.png)](https://substackcdn.com/image/fetch/$s_!lFOI!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6f043a94-7c2c-4c37-9d56-b627138a60b8_1744x238.png)
...
[![](https://substackcdn.com/image/fetch/$s_!Hxsw!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4e712d05-e3d0-4d5f-9c27-5a9b89b4b156_2048x298.png)](https://substackcdn.com/image/fetch/$s_!Hxsw!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4e712d05-e3d0-4d5f-9c27-5a9b89b4b156_2048x298.png)

The cluster provided a reasonable (though strange) `add-user` convenience script to make new Linux users.

[![](https://substackcdn.com/image/fetch/$s_!M7u8!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc421b89f-eb94-43ca-a479-45e4885de096_1308x822.png)](https://substackcdn.com/image/fetch/$s_!M7u8!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc421b89f-eb94-43ca-a479-45e4885de096_1308x822.png)

It did not provide, however, basic packages like `pip`, `git`, or even `sudo`.

[![](https://substackcdn.com/image/fetch/$s_!WZNP!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F02307a5c-746c-40ed-ac40-d402528367c2_1292x72.png)](https://substackcdn.com/image/fetch/$s_!WZNP!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F02307a5c-746c-40ed-ac40-d402528367c2_1292x72.png)[![](https://substackcdn.com/image/fetch/$s_!N22A!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F42e8d396-2de6-4d06-b1e0-df2d635a9340_946x69.png)](https://substackcdn.com/image/fetch/$s_!N22A!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F42e8d396-2de6-4d06-b1e0-df2d635a9340_946x69.png)[![](https://substackcdn.com/image/fetch/$s_!f-ha!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4dcc0786-1a69-42d6-93fd-73ba6e53865b_783x70.png)](https://substackcdn.com/image/fetch/$s_!f-ha!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F4dcc0786-1a69-42d6-93fd-73ba6e53865b_783x70.png)
...
[![](https://substackcdn.com/image/fetch/$s_!XFSc!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F265cf619-792d-401e-a5d4-a2de20f10a35_2048x798.png)](https://substackcdn.com/image/fetch/$s_!XFSc!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F265cf619-792d-401e-a5d4-a2de20f10a35_2048x798.png)
...
[![](https://substackcdn.com/image/fetch/$s_!ZdtQ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff24cf8a2-afbd-43a3-9537-ffa22f1dea42_1425x78.png)](https://substackcdn.com/image/fetch/$s_!ZdtQ!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff24cf8a2-afbd-43a3-9537-ffa22f1dea42_1425x78.png)
...
Runpod is a neocloud headquartered in Moorestown, New Jersey with a fleet including RTX PRO 6000, H100, H200, B200, and B300. This June, [they raised $100M at a $1B valuation](https://www.prnewswire.com/news-releases/runpod-raises-100m-led-by-summit-partners-to-accelerate-the-ai-developer-cloud-302808689.html), announcing on Twitter that [their revenue doubled to $240M ARR from February to June](https://x.com/LukePiette/status/2069822990615728333).
...
[![](https://substackcdn.com/image/fetch/$s_!8EJN!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb3b62b74-729a-4b4e-92fd-8672fbbfa140_2048x1113.png)](https://substackcdn.com/image/fetch/$s_!8EJN!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb3b62b74-729a-4b4e-92fd-8672fbbfa140_2048x1113.png)
...
We find the Runpod team unusually receptive to feedback and eager to explain their decisions. We like that [the majority of their job postings are in serious engineering roles](https://www.runpod.io/careers), and we hope they continue to work to strike a better balance between ease of access and developer control.

### Bitdeer

Bitdeer was a new inclusion in ClusterMAX testing as of ClusterMAX 2.1. Yet another crypto miner pivoting to AI, Bitdeer already has an impressive 1.75GW in total electrical capacity [according to its most recent announcement](https://ir.bitdeer.com/news-releases/news-release-details/bitdeer-reports-unaudited-financial-results-second-quarter-2026). However, this mostly feeds cryptocurrency mining rigs: [our SemiAnalysis Datacenter Industry Model estimates they only have a handful of AI MW online](https://atlas.semianalysis.com/?dashboard=datacenter_model). Still, Bitdeer is steering hard toward the higher-margin GPU business, with hundreds of MW already in the pipeline over the next couple of years as it works on sites, either converted or now, in Knoxville, Wenatchee, Fox Creek, and Rockdale, as well as in Norway and Malaysia. Hoping to grow its business vertically as well as horizontally, Bitdeer is not content with mere colo deals, with fledgling offerings from token-as-a-service to managed agents to, of course, managed clusters.

[![](https://substackcdn.com/image/fetch/$s_!epx5!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1f265b3a-94a5-4931-b066-fdcccf9de49a_1496x902.png)](https://substackcdn.com/image/fetch/$s_!epx5!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1f265b3a-94a5-4931-b066-fdcccf9de49a_1496x902.png)

_caption:_ Source: bitdeer.ai
...
[![](https://substackcdn.com/image/fetch/$s_!o1Iu!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7f84fb39-e5a1-4e8e-b260-1f8d47fe13d6_1280x857.png)](https://substackcdn.com/image/fetch/$s_!o1Iu!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7f84fb39-e5a1-4e8e-b260-1f8d47fe13d6_1280x857.png)
...
Indian neocloud Neysa announced a [$1.2B in financing this February](https://neysa.ai/press-release/blackstone-leads-funding-of-over-1-billion-dollar-to-neysa/), including $600M equity and $600M debt, in a round led by Blackstone that left them at $1.4B post-money. They claim “[9,216 air-cooled NVIDIA B300 staged between December 2026 and March 2027](https://neysa.ai/blog/hpc-architecture/),” with an equal number of AMD MI350X in the pipeline as well. Impressive growth, and clearly the leader in India in this regard.

This round, our testing unfortunately revealed a cluster that was riddled with errors. Many software packages that came pre-installed during cluster provisioning were months or even years out of date, with several serious CVEs applicable. CUDA Toolkit 12.0, for example, was [released in December 2022](https://developer.nvidia.com/cuda-toolkit-archive), making it older than Neysa itself. Somehow this was installed on our cluster at /usr/bin/nvcc.
...
Sharon AI is an Australian neocloud that [claims 132MW in its pipeline, with 116MW already contracted out](https://sharonai.com/press-releases/sharon-ai-announces-us1-32-billion-five-year-cloud-computing-service-agreement/), against a current footprint that we estimate around 4 MW. They do not have SOC 2 or ISO 27001. We were able to test 2 bare metal H200 nodes to verify basic functionality. We look forward to testing Sharon AI down the line as their offerings mature.
...
With that said, the new builds in Childress and Sweetwater look much better (read: not N+0 power, cooling, and ISPs!). We’ve covered plenty about these sites in our Datacenter Model, suffice it to say that despite all the technical shortcomings in their cloud services, we expect the [$2.1B investment from NVIDIA](https://nvidianews.nvidia.com/news/nvidia-and-iren-announce-strategic-partnership-to-accelerate-deployment-of-up-to-5-gigawatts-of-ai-infrastructure) will help them cut less corners this time around.
...
Hydra Host raised a [$100M Series A](https://hydrahost.com/post/tokens-are-the-new-oil-hydra-host-series-a/) in June 2026, with NVIDIA among its backers. They are focusing on brokering deals, and our earlier testing is all we have to go on for managed cluster experience. We need to test a real managed cluster before considering an upgrade.
...
WhiteFiber raised [$159.4M gross at its initial IPO closing](https://www.whitefiber.com/news?id=19) in August 2025. Our prior testing found good network performance but unusable Slurm/Kubernetes integration and weak job monitoring. More recent customer feedback suggested improvement, though the ephemeral Slurm login filesystem remained a concern. We need to verify that these operational problems are fixed.

### PaleBlueDot

PaleBlueDot raised a [$150M Series B](https://www.prnewswire.com/news-releases/palebluedot-ai-raises-150m-series-b-to-scale-global-ai-compute-infrastructure-302672782.html) led by B Capital in January 2026. We previously found its marketplace easy to use for individual VMs, but it lacked a complete managed-cluster experience. Unfortunately, they have shut down their on-demand console in favor of serving some big customers in dedicated datacenters.
...
Mithril, formerly Foundry, announced [$80M in funding back in 2024](https://mithril.ai/blog/introducing-foundry) to “restore the promise of public cloud to AI”. Today, it’s a marketplace wrapping 3 Nebius availability zones with H100 or H200, though only the H200’s have an option with a scale-out network.

[![](https://substackcdn.com/image/fetch/$s_!pOU2!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F15b5188b-419c-4668-beb5-cec14d49a018_911x313.png)](https://substackcdn.com/image/fetch/$s_!pOU2!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F15b5188b-419c-4668-beb5-cec14d49a018_911x313.png)

_caption:_ Source: Mithril website
...
Massed Compute last announced capital raise involved [up to $300M in equity and revenue-share financing](https://www.hpcwire.com/off-the-wire/massed-compute-gains-300m-backing-for-nvidia-powered-ai-cloud-expansion/) from Digital Alpha in August 2025. They have used this to drive reasonable growth for a bare metal business, but that alone does not cut it on the ClusterMAX rating system, especially since their [slop cannon chatbot](https://massedcompute.com/faq-answers/?question=What%20are%20the%20key%20features%20of%20NVIDIA%20H100%20GPUs%20that%20enable%20improved%20performance%20in%20machine%20learning%20workloads%3F#:~:text=These%20answers%20are%20generated%20by%20an%20AI%20system%20and%20may%20be%20incomplete%20or%20inaccurate.) is still getting indexed by web crawlers.
...
- Those that we have previously tested who now claim to have zero spare capacity and/or refuse to test with us. This includes Fluidstack, Cirrascale, Lightning AI (recently merged with Voltage Park), Scaleway, CUDO Compute, Denvr Dataworks, and Atlas Cloud.
- Those that are yet to launch, yet to be tested, and are generally interesting to us, though we believe some unnamed of this bunch are misleading investors (i.e., lying) by claiming in public marketing materials that they do managed clusters when they really just do bare metal. This includes SpaceXAI, Mistral, Poolside Infrastructure Company, Nscale, Highrise, Corvex, Andromeda, Volta, Firebird, Tatra, Sesterce, Yotta, Boostrun, GlobalAI, Argentum and Qumulus.
- Those who are big and important, but who we cannot test properly due to geographic or regulatory concerns. This includes Alibaba Cloud, MegaSpeed, BytePlus, RunSun, SK Telecom, Naver Cloud and Indosat/Zankore/Lintasarta.
- Those who are too small to be relevant. These are still covered in our market view, but not part of the rating system.
...
Volta launched with [$300M in venture funding and a separate $5B financing pool](https://www.bloomberg.com/news/articles/2026-08-04/nvidia-dell-back-ai-cloud-startup-volta-at-2-4-billion-value) for customers. Its first large announced contract uses Bitdeer’s Norway site. We have not tested the cloud software or customer operations.

### Firebird

Firebird is building GPU infrastructure in Armenia, with $60M in construction financing announced by Ameriabank, and expansion plans in Kazakhstan. Recently, they became the subject of [a story about Nvidia chip access and the Armenia-Azerbaijan peace process; co-founder Razmig Hovaghimian responded that the project had roots going back years before those diplomatic developments](https://zartonkmedia.com/2026/09/06/following-wsj-report-firebird-co-founder-offers-context-armenia-ai-project-has-roots-going-back-years-built-to-make-armenia-a-global-technology-powerhouse/). GPU diplomacy. Pressure’s on to deliver for the people of Armenia! We still need to see the managed cloud in action.
...
Groq set out to challenge Nvidia, but after a licensiquihire took Jonathan Ross and most of the engineering team, the remaining company has pivoted… to renting out Nvidia GPUs! Becoming a neocloud is the move if you want another $350M to live out your dreams (as [announced in August](https://groq.com/newsroom/groq-becomes-an-nvidia-cloud-partner)). We look forward to testing more than just endpoints one day. Jensen gets the chip team and another customer. Not bad.
