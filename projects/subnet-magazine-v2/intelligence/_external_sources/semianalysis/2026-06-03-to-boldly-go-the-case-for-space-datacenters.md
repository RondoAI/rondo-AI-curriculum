...
date: "2026-06-03"
authors: ["Daniel Nishball", "Pranav Myana", "Ellie Holbrook", "Harley Blackard", "Zane Fong", "Cheang Kang Wen", "Sravan Kundojjala", "Tanj Bennett", "Myron Xie", "Terence Ong"]
audience: "only_paid"
paywalled: true
wordcount: 18579
url: "https://newsletter.semianalysis.com/p/to-boldly-go-the-case-for-space-datacenters"
post_id: 199606197
captured_at: "2026-06-03T16:26:50.408985+00:00"
---
...
> **Paywalled.** Captured below is the free preview Substack renders publicly (78,931 chars of body markdown). For long-form analyses this is typically 70 to 90 percent of the article, with the final deep-dive section paywalled. The Oracle may cite the captured content; do not assert claims that depend on the paywalled tail (look for a 'This post is for paid subscribers' marker at the end of the body).
...
“Five years from now, my prediction is we will launch and be operating every year more AI in space than the cumulative total on Earth... I would expect to be at least, sort of five years from now, a few hundred gigawatts per year of AI in space and rising.”- Elon Musk on [Dwarkesh Podcast](https://youtu.be/BYXbuik3dgA?t=953), February 2026
...
_caption:_ Source: SemiAnalysis AI Space Datacenter TCO Model
...
Part Two will focus on discussing the four layers of incremental power supply here on earth after briefly addressing a few of the casual arguments for space datacenters.Part Three introduces the[AI Space Datacenter Total Cost of Ownership (TCO) Model](https://semianalysis.com/institutional/space-dc-tco-model/)and explains the SemiAnalysis TCO framework that is used in the model to discuss and compare costs for terrestrial and space datacenters.Part Four explains in detail the build up of a space datacenter with a system by system cost breakdown as well as a discussion of the science behind space datacenter design and implementation.
...
The model will answer the question of if and when space datacenters will become economical and will show the scenarios with respect to end demand and costs on Earth that make Space a viable deployment option.Please reach out to [sales@semianalysis.com](mailto:sales@semianalysis.com) to find out more!
...
_caption:_ Source: Scientific American
...
_caption:_ Source: SemiAnalysis AI Space Datacenter TCO Model, SemiAnalysis Energy Model
...
_caption:_ Source: SemiAnalysis AI Datacenter Model, SemiAnalysis AI Space Datacenter TCO Model
...
_caption:_ Source: SemiAnalysis Accelerator Model, SemiAnalysis Foundry Model
...
_caption:_ Source: SemiAnalysis Wafer Fab Equipment Model, SemiAnalysis Foundry Model
...
[Subscribe](https://newsletter.semianalysis.com/subscribe?simple=true&next=https%3A%2F%2Fnewsletter.semianalysis.com%2Fp%2Fto-boldly-go-the-case-for-space-datacenters&utm_source=paywall&utm_medium=web&utm_content=199606197)
