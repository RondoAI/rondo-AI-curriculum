...
post_id: 203488628
captured_at: "2026-06-25T21:28:52.704588+00:00"
---
...
> **Paywalled.** Captured below is the free preview Substack renders publicly (41,767 chars of body markdown). For long-form analyses this is typically 70 to 90 percent of the article, with the final deep-dive section paywalled. The Oracle may cite the captured content; do not assert claims that depend on the paywalled tail (look for a 'This post is for paid subscribers' marker at the end of the body).
...
_caption:_ Source: SemiAnalysis Energy Model, SemiAnalysis Datacenter Model
...
_caption:_ Source: SemiAnalyis Energy Model
...
[![](https://substackcdn.com/image/fetch/$s_!ufSn!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F444f2618-eda9-471d-879f-775296602aa0_1920x1080.png)](https://substackcdn.com/image/fetch/$s_!ufSn!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F444f2618-eda9-471d-879f-775296602aa0_1920x1080.png)
...
- ICAP reserves: ICAP means Installed Capacity and is a proxy for nameplate capacity. A fairly common requirement across ISOs is 15-20% required ICAP reserves. PJM, for instance, sizes its capacity requirement to a 1-in-10 loss-of-load-expectation (LOLE) standard, which currently translates to an installed reserve margin (IRM) target of roughly 20%.[![](https://substackcdn.com/image/fetch/$s_!VLIf!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faceabb2b-16f7-4a94-a79b-59d969dcfa84_1920x1080.png)](https://substackcdn.com/image/fetch/$s_!VLIf!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faceabb2b-16f7-4a94-a79b-59d969dcfa84_1920x1080.png) _caption:_ Source: SemiAnalysis Energy Model
...
- Two load co-location agreements from the same POI (265.5 MW + 260 MW = 525.5 MW total) are expected to serve a ~1 GW IT campus.Crusoe also has a TCEQ air-permit filing for up to 933 MW of gross nameplate gas generation, of which we expect ~665 MW is the 19x GE Vernova LM2500 turbines (~35 MW each)
...
_caption:_ Source: ERCOT Batch Study Workshop 8 – May 4th, 2026
...
[Subscribe](https://newsletter.semianalysis.com/subscribe?simple=true&next=https%3A%2F%2Fnewsletter.semianalysis.com%2Fp%2Fus-grid-constraints-towards-40gw&utm_source=paywall&utm_medium=web&utm_content=203488628)
