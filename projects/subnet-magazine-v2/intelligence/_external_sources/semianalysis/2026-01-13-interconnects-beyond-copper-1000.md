...
> **Paywalled.** Captured below is the free preview Substack renders publicly (41,000 chars of body markdown). For long-form analyses this is typically 70 to 90 percent of the article, with the final deep-dive section paywalled. The Oracle may cite the captured content; do not assert claims that depend on the paywalled tail (look for a 'This post is for paid subscribers' marker at the end of the body).
...
> There are 4 main avenues for scaling the storage capacity of NAND Flash per wafer.1. Logical scaling – The number of bits stored per cell. This requires storing 2^n voltage levels per cell.2. Vertical scaling – The number of NAND cells stacked vertically3. Lateral scaling – The size/number of cells that can be fit on the 2D vector4. Architecture scaling – Various techniques to increase density and reduce overhead from cells/periphery.

[![](https://substackcdn.com/image/fetch/$s_!TN8Z!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3106815d-d4bb-49e5-8e6e-d90f91a5258e_1345x893.jpeg)](https://substackcdn.com/image/fetch/$s_!TN8Z!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3106815d-d4bb-49e5-8e6e-d90f91a5258e_1345x893.jpeg)

_caption:_ Source: Western Digital
...
[![](https://substackcdn.com/image/fetch/$s_!4od_!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe2a6399f-c0b9-4267-bd08-e970df1839e9_2919x1501.jpeg)](https://substackcdn.com/image/fetch/$s_!4od_!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe2a6399f-c0b9-4267-bd08-e970df1839e9_2919x1501.jpeg)

_caption:_ Typical 3D NAND architecture. Vertical channels intersect with alternating conductive and insulating layers. A memory cell is formed at each conductive intersection. Source: Lam Research
...
[![](https://substackcdn.com/image/fetch/$s_!XmN0!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F993de94d-7542-412b-a97f-83ddad6ed4d1_595x466.png)](https://substackcdn.com/image/fetch/$s_!XmN0!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F993de94d-7542-412b-a97f-83ddad6ed4d1_595x466.png)

_caption:_ NAND layer count is increasing rapidly; it’s the most cost-effective way to scale NAND density at the moment. Source: SK Hynix
...
[![](https://substackcdn.com/image/fetch/$s_!VSpI!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe84ba74b-fa14-4904-8069-77060cf93a06_772x483.png)](https://substackcdn.com/image/fetch/$s_!VSpI!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe84ba74b-fa14-4904-8069-77060cf93a06_772x483.png)

_caption:_ SK Hynix NAND generations side-by-side. The decks/plugs could no longer get any taller after V8, so a 3rd deck had to be added, increasing complexity and cost. Source: SK Hynix

[![](https://substackcdn.com/image/fetch/$s_!Q_n1!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fce487726-7c0b-4d4a-9045-3dffb63015a5_3060x1600.png)](https://substackcdn.com/image/fetch/$s_!Q_n1!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fce487726-7c0b-4d4a-9045-3dffb63015a5_3060x1600.png)

_caption:_ Hynix lateral scaling with 11% block pitch reduction, moving to 16 rows between slits without dummy rows. Source: SK Hynix
...
[![](https://substackcdn.com/image/fetch/$s_!BvY9!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe954a11b-b41b-46db-9c59-caa433365be9_703x172.png)](https://substackcdn.com/image/fetch/$s_!BvY9!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe954a11b-b41b-46db-9c59-caa433365be9_703x172.png)

_caption:_ Process for depositing a linerless Mo layer. A MoN liner is deposited and then converted to pure Mo. Note that fluorine is not needed in this process, reducing the danger to nearby dielectric material. Source: Samsung
...
[![](https://substackcdn.com/image/fetch/$s_!5ZbV!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F444859b7-1f83-46b9-a513-64c08a1f4628_704x301.png)](https://substackcdn.com/image/fetch/$s_!5ZbV!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F444859b7-1f83-46b9-a513-64c08a1f4628_704x301.png)

_caption:_ Reading 32 different states from a traditional NAND cell is nearly impossible, the sensing margin is too narrow. Reading 6 each from 2 multi-site cells makes this practical. Source: SK Hynix
...
[![](https://substackcdn.com/image/fetch/$s_!RKjt!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F87226b05-02c9-4670-b0d7-0c3ea48c1743_406x504.png)](https://substackcdn.com/image/fetch/$s_!RKjt!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F87226b05-02c9-4670-b0d7-0c3ea48c1743_406x504.png)

_caption:_ Fabrication overview of the Hynix multi-site cell NAND architecture. Dividing an oval in 2 and depositing thin films in high-aspect, asymmetric holes will be a big challenge to yield in high volume. Source: SK Hynix

[![](https://substackcdn.com/image/fetch/$s_!LWPU!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffe98ab61-b468-48fd-a633-33083343fdad_561x415.png)](https://substackcdn.com/image/fetch/$s_!LWPU!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffe98ab61-b468-48fd-a633-33083343fdad_561x415.png)[![](https://substackcdn.com/image/fetch/$s_!iPCD!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faf08539a-0dcd-4c52-aeaa-0ca4faad7d45_561x415.png)](https://substackcdn.com/image/fetch/$s_!iPCD!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faf08539a-0dcd-4c52-aeaa-0ca4faad7d45_561x415.png)

_caption:_ Despite manufacturing challenges, Hynix was able to produce working devices on-wafer. The dimensions and memory density of this demonstration aren’t known. Source: SK Hynix

## Next Gen Interconnects: Samsung Ruthenium

As semiconductor nodes scale below 10 nm, traditional copper (Cu) interconnects encounter a critical bottleneck caused by the “size effect,” where resistivity rises sharply as the relative volume of barriers and liners increases. To address this challenge, the industry has begun exploring ruthenium (Ru) as a superior alternative. Samsung introduced Grain Orientation Engineering through Ruthenium Atomic Layer Deposition (ALD), achieving a highly textured film with 99% (001) orientation. Compared with traditional sputtering (PVD) or conventional ALD processes, this approach significantly reduces electron scattering at grain boundaries. Experimental results indicate that in ultra-fine interconnects with a cross-sectional area of only 300 nm², ruthenium lines fabricated using orientation engineering exhibit 46% lower resistance. Also, TCAD simulations on Gate-All-Around (GAA) FET structures showed a 26% RC reduction when using highly textured Ru M1 lines.

[![](https://substackcdn.com/image/fetch/$s_!POYl!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5d29ed9f-cecc-4a5b-be46-49b2440e92d8_447x317.png)](https://substackcdn.com/image/fetch/$s_!POYl!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5d29ed9f-cecc-4a5b-be46-49b2440e92d8_447x317.png)

_caption:_ For the filling of 3D structures and ultra-fine vias, the research team developed an “inhibitor-free” Area-Selective Deposition (ASD) process. Source: Samsung
...
[![](https://substackcdn.com/image/fetch/$s_!_Bm1!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2840cf54-a232-4921-895d-7a47babfb366_655x316.png)](https://substackcdn.com/image/fetch/$s_!_Bm1!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2840cf54-a232-4921-895d-7a47babfb366_655x316.png)

_caption:_ Source: Samsung
...
[![](https://substackcdn.com/image/fetch/$s_!pQ0s!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdd4ecb2e-ce65-4e4c-b71f-75e397646b46_727x295.png)](https://substackcdn.com/image/fetch/$s_!pQ0s!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdd4ecb2e-ce65-4e4c-b71f-75e397646b46_727x295.png)

_caption:_ Source: imec

Why Fully Self-Aligned Vias?At a 16 nm pitch, the via critical dimension (CD) is approximately 8 nm, with an 8 nm spacing as well. Such extremely small dimensions introduce significant challenges:
...
[![](https://substackcdn.com/image/fetch/$s_!yOYU!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F517f0b93-0926-4603-bcbc-701e52a0618a_592x441.png)](https://substackcdn.com/image/fetch/$s_!yOYU!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F517f0b93-0926-4603-bcbc-701e52a0618a_592x441.png)

_caption:_ Source: imec

The overall process is as follows:First use low-NA EUV lithography for patterning the stacked layers and photoresist. Next, the patterns are transferred to the silicon layer through a combination of dry and wet etching. Spacer deposition and etch-back are then applied to achieve double patterning. After that, CMP (Chemical Mechanical Planarization) is performed for surface flattening, and finally, selective removal of SiN is carried out.

[![](https://substackcdn.com/image/fetch/$s_!BVhW!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8a358a0c-9e63-4b73-bed2-d8e37f286142_613x307.png)](https://substackcdn.com/image/fetch/$s_!BVhW!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8a358a0c-9e63-4b73-bed2-d8e37f286142_613x307.png)

_caption:_ Source: imec

[![](https://substackcdn.com/image/fetch/$s_!WzIn!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffdbd99cb-609e-4739-bf79-c969c03fb9b9_686x327.png)](https://substackcdn.com/image/fetch/$s_!WzIn!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffdbd99cb-609e-4739-bf79-c969c03fb9b9_686x327.png)
...
[![](https://substackcdn.com/image/fetch/$s_!bwlg!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe6eafda4-673c-4b5f-a184-c5aac8ecf0b8_697x321.png)](https://substackcdn.com/image/fetch/$s_!bwlg!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe6eafda4-673c-4b5f-a184-c5aac8ecf0b8_697x321.png)

_caption:_ Imec successfully achieved two-layer ruthenium interconnects at a 16 nm pitch with yield exceeding 80%. Source: imec
...
[![](https://substackcdn.com/image/fetch/$s_!wRfr!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8b2a2f8a-2305-410c-bea0-345b18beac1e_825x691.png)](https://substackcdn.com/image/fetch/$s_!wRfr!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8b2a2f8a-2305-410c-bea0-345b18beac1e_825x691.png)

_caption:_ Source: Cheliotis & Zergioti, NTU Athens

Once you accept that the near-term battle is integration, the next battle is even more unforgiving: contacts. Performance must improve to meet industrial requirements, and contact resistance has always been the focal point because it determines whether the device is contact-limited. Plenty of prior work reports low n-type contact resistance for MoS₂ under specific contact schemes, but the fine print is that these results are often demonstrated at high VGS and VDS, which is not the bias regime that matters for products. The relevant target regime is low voltage operation, with |VGS| [![](https://substackcdn.com/image/fetch/$s_!VyyN!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F40e0e977-52c4-475f-b8dd-20c8ad0ed089_1220x970.png)](https://substackcdn.com/image/fetch/$s_!VyyN!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F40e0e977-52c4-475f-b8dd-20c8ad0ed089_1220x970.png)

_caption:_ Source: Pin-Chun Shen et al., “Ultralow contact resistance between semimetal and monolayer semiconductors,” Nature 593, 211–217 (2021)
...
[![](https://substackcdn.com/image/fetch/$s_!bpCy!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8e617273-2079-459b-a7f4-75884e1d4c6b_816x674.png)](https://substackcdn.com/image/fetch/$s_!bpCy!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8e617273-2079-459b-a7f4-75884e1d4c6b_816x674.png)

_caption:_ Source: Yoon, H.H., Park, J.Y., Megra, Y.T. et al. Enabling the Angstrom Era: 2D material-based multi-bridge-channel complementary field effect transistors. npj 2D Mater Appl 9, 68 (2025).
...
[![](https://substackcdn.com/image/fetch/$s_!cOcQ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F20297eaf-b8b5-4e16-b68b-f4151bce1d6d_1002x632.png)](https://substackcdn.com/image/fetch/$s_!cOcQ!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F20297eaf-b8b5-4e16-b68b-f4151bce1d6d_1002x632.png)

_caption:_ Source: Thomas, Mathew, Nair, & O’Dowd “2D MoS2: structure, mechanisms and photocatalytic applications”
...
[![](https://substackcdn.com/image/fetch/$s_!sLcI!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9953ea65-fcd3-4dad-91ce-4e14690e4839_764x616.png)](https://substackcdn.com/image/fetch/$s_!sLcI!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9953ea65-fcd3-4dad-91ce-4e14690e4839_764x616.png)

_caption:_ Source: Hong, Lin, Chenguang, & Jing “Two-Dimensional Transistors beyond Silicon Counterparts: From Theory to Experiment”
...
[![](https://substackcdn.com/image/fetch/$s_!60J5!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8e3a9461-9a58-4068-add3-95e18e1592d6_722x494.png)](https://substackcdn.com/image/fetch/$s_!60J5!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8e3a9461-9a58-4068-add3-95e18e1592d6_722x494.png)

_caption:_ Source: TSMC

[![](https://substackcdn.com/image/fetch/$s_!HUST!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fedf694c8-1bb0-48f2-9301-cab5a0bc3adf_724x490.png)](https://substackcdn.com/image/fetch/$s_!HUST!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fedf694c8-1bb0-48f2-9301-cab5a0bc3adf_724x490.png)
...
[![](https://substackcdn.com/image/fetch/$s_!-59S!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F85f74f6e-2af9-48cc-9432-bbbaedcb5c49_1244x192.png)](https://substackcdn.com/image/fetch/$s_!-59S!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F85f74f6e-2af9-48cc-9432-bbbaedcb5c49_1244x192.png)

_caption:_ Source: J. Kang, S. Tongay, J. Zhou, J. Li, and J. Wu, “Computational Study of Metal Contacts to Monolayer Transition-Metal Dichalcogenide Semiconductors,” Physical Review X 2014

[![](https://substackcdn.com/image/fetch/$s_!7nna!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fecaaf3fb-6a4c-44c4-a839-5eede7669447_1034x422.png)](https://substackcdn.com/image/fetch/$s_!7nna!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fecaaf3fb-6a4c-44c4-a839-5eede7669447_1034x422.png)

_caption:_ Source: Hung et al., “Mechanics of Integration and Component Performance Step-up for Nanosheet Transistors with Ultrathin 2D Channel,” 2025 IEEE International Electron Devices Meeting (IEDM) (2025)
...
[Subscribe](https://newsletter.semianalysis.com/subscribe?simple=true&next=https%3A%2F%2Fnewsletter.semianalysis.com%2Fp%2Finterconnects-beyond-copper-1000&utm_source=paywall&utm_medium=web&utm_content=184077729)
