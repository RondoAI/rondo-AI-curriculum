---
source: "SemiAnalysis"
title: "Nvidia’s Backstop Universe – Heads I Win, Tails Who Loses?"
...
post_id: 215201423
captured_at: "2026-09-11T18:56:35.657198+00:00"
---
...
> **Paywalled.** Captured below is the free preview Substack renders publicly (15,999 chars of body markdown). For long-form analyses this is typically 70 to 90 percent of the article, with the final deep-dive section paywalled. The Oracle may cite the captured content; do not assert claims that depend on the paywalled tail (look for a 'This post is for paid subscribers' marker at the end of the body).

Follow the money behind the AI buildout with our [AI Compute, Capital and Markets Model](https://semianalysis.com/capital-and-markets/) - understand who is funding the expansion, how deals are structured, and where the risks sit. Contact our team [here](https://semianalysis.com/capital-and-markets/) to find out more.
...
If you want to combine financial analysis with a detailed understanding of the technology and economics behind AI infrastructure, we’d like to hear from you - apply [here](https://semianalysis.com/semianalysis-careers/).
...
[![](https://substackcdn.com/image/fetch/$s_!pB4q!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8d94950a-1e04-42e0-b237-830e196c667f_10117x5325.png)](https://substackcdn.com/image/fetch/$s_!pB4q!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8d94950a-1e04-42e0-b237-830e196c667f_10117x5325.png)

_caption:_ Source: SemiAnalysis AI Compute, Capital and Markets Model
...
[![](https://substackcdn.com/image/fetch/$s_!LTkq!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1e9456e6-b3ce-4e25-a11a-2a2fc6dc2df4_1331x907.png)](https://substackcdn.com/image/fetch/$s_!LTkq!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1e9456e6-b3ce-4e25-a11a-2a2fc6dc2df4_1331x907.png)

_caption:_ Source: SemiAnalysis AI Compute, Capital and Markets Model

## Why all the Guarantees and Backstops?

The mechanism that gives rise to these off-balance sheet guarantees and backstops is the same one we described in [The Front End Gets Crowded](https://semianalysis.com/institutional/the-front-end-gets-crowded-nvidias-500b-push-broadcoms-response-and-the-next-wave-of-ai-credit/) (institutional article). The Gigascalers (Amazon, Microsoft, Google, Meta, Oracle) have been gatekeeping the investment grade capital that the AI buildout runs on and have benefitted tremendously from the high spread between offtake price they are being charged, and spot/short-term price that they are selling at as well as services that sit on top. In response, Nvidia has been manufacturing alternative credit anchors so Neoclouds and Neolabs can raise money without the Gigascalers. In these support arrangements, Nvidia sells GPUs at full margin on day one, then floors the buyer’s revenue (in the case of the AI Cloud Partner (AICP) Program), or guarantees the buyer’s landlord, or signs the lease itself, all so that non IG-rated operators can effectively borrow at IG rated pricing.
...
[![](https://substackcdn.com/image/fetch/$s_!3Kwp!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff4a7879f-403c-43dc-b849-42258bcfa2b1_2847x1099.png)](https://substackcdn.com/image/fetch/$s_!3Kwp!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff4a7879f-403c-43dc-b849-42258bcfa2b1_2847x1099.png)
...
[![](https://substackcdn.com/image/fetch/$s_!ouqz!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7f430a90-ab4c-426a-9bf0-97b999130ffc_4492x2403.png)](https://substackcdn.com/image/fetch/$s_!ouqz!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7f430a90-ab4c-426a-9bf0-97b999130ffc_4492x2403.png)

_caption:_ Source: SemiAnalysis AI Compute, Capital and Markets Model

### Residual Value Guarantees under Capital Partnerships

Earlier in August 2026, Nvidia announced its partnership with a number of private equity funds to mobilize over $500B of third-party capital to support the buildout of AI Clusters. Under this program, institutional investors are in the driver’s seat and will evaluate and price each proposed project, with the only support from Nvidia being a residual value guarantee for up to 25% of a deal. In his [X post detailing the program](https://x.com/JensenHuang/status/2086934705207959965), Jensen Huang highlighted that this support would be limited and on a project-by-project basis. Though there are few details on what such a program could look like, we drew inspiration from the Google-Broadcom-Anthropic-Apollo TPU structure to surmise how deals could be structured.
...
[![](https://substackcdn.com/image/fetch/$s_!MNOb!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F19f985c8-8b14-4f92-88c6-91aacc465e7f_2105x1420.png)](https://substackcdn.com/image/fetch/$s_!MNOb!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F19f985c8-8b14-4f92-88c6-91aacc465e7f_2105x1420.png)
...
[![](https://substackcdn.com/image/fetch/$s_!zvVd!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa0ca56cf-6c00-422e-a710-59b69341667b_4493x2403.png)](https://substackcdn.com/image/fetch/$s_!zvVd!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa0ca56cf-6c00-422e-a710-59b69341667b_4493x2403.png)
...
[Subscribe](https://newsletter.semianalysis.com/subscribe?simple=true&next=https%3A%2F%2Fnewsletter.semianalysis.com%2Fp%2Fnvidias-backstop-universe-heads-i&utm_source=paywall&utm_medium=web&utm_content=215201423)
