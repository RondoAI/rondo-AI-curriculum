...
subtitle: "1,000+ facilities across 60+ operators mapped, built retail-first and flipped by AI, largest hyperscaler leases 1/5 national capacity, 100MW in 12 months, Eastern Data Western Compute"
date: "2026-09-25"
...
post_id: 215007982
captured_at: "2026-09-25T23:02:21.558825+00:00"
---
...
> **Paywalled.** Captured below is the free preview Substack renders publicly (33,167 chars of body markdown). For long-form analyses this is typically 70 to 90 percent of the article, with the final deep-dive section paywalled. The Oracle may cite the captured content; do not assert claims that depend on the paywalled tail (look for a 'This post is for paid subscribers' marker at the end of the body).
...
As with our flagship [SemiAnalysis Datacenter Model](https://semianalysis.com/datacenter-industry-model/), we use building-level data to show which of the most widely cited narratives hold, starting with how large the market is.
...
[![](https://substackcdn.com/image/fetch/$s_!dpt-!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F713c729d-e750-45c3-b09a-2cacd2f3bb59_4290x2414.png)](https://semianalysis.com/china-datacenter-model/)

_caption:_ Source: SemiAnalysis Datacenter Model, SemiAnalysis China Datacenter Model
...
[![](https://substackcdn.com/image/fetch/$s_!-k6q!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3e97ef02-346a-42fa-9676-b4975fa87339_2000x1120.png)](https://substackcdn.com/image/fetch/$s_!-k6q!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3e97ef02-346a-42fa-9676-b4975fa87339_2000x1120.png)
...
[![](https://substackcdn.com/image/fetch/$s_!x5jG!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6636c148-c8b8-4256-892f-1f345a94134c_3000x1725.png)](https://semianalysis.com/china-datacenter-model/)

_caption:_ Source: SemiAnalysis China Datacenter Model
...
The growth does not stop at China’s border. Overseas leasing by Chinese hyperscalers is set to double from 2026 to 2029 and approach ~4GW of leased capacity in our [SemiAnalysis Datacenter Model](https://semianalysis.com/datacenter-industry-model/). That number still understates their offshore compute, because it excludes the hundreds of thousands of GPUs they rent from Western clouds, which we covered at length in [How Oracle Is Winning the AI Compute Market](https://semianalysis.com/2025/06/30/how-oracle-is-winning-the-ai-compute-market/).
...
This report is a preview of the [SemiAnalysis China Datacenter Model](https://semianalysis.com/china-datacenter-model/). It is the China counterpart to our global [SemiAnalysis Datacenter Model](https://semianalysis.com/datacenter-industry-model/), built to the same standard, bottom-up and building by building.
...
Consider it the opening chapter. As with our global [Datacenter Model](https://semianalysis.com/datacenter-industry-model/), we will keep adding layers (AI capacity, power, suppliers, supply/demand analysis) with every update.
...
[![](https://substackcdn.com/image/fetch/$s_!_P5e!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe64df824-b5a1-436a-9973-87b6a0cf264c_2145x1207.png)](https://semianalysis.com/china-datacenter-model/)

_caption:_ Source: VNET disclosure, SemiAnalysis
...
[![](https://substackcdn.com/image/fetch/$s_!J3Uc!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fda157796-9830-4c13-b321-2dac61de032a_2000x1120.png)](https://substackcdn.com/image/fetch/$s_!J3Uc!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F