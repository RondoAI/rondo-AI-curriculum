# Intelligence Digest, 2026-09-15
...
- @a16zcrypto (a16z Crypto, Sat, 12 Sep 2026): What would the CLARITY Act mean for people building and using crypto? 10 building blocks to understand, from how tokens are regulated to protections for open source developers and self-custody.  
  https://nitter.kareem.one/a16zcrypto/status/2098781678336692585#m
...
- @JosephJacks_ (Joseph Jacks, Mon, 14 Sep 2026): Article open the frontier the frontier is the edge of what we know. no company owns what comes next. i want more people to be able to advance it. i favor open releases that people can examine, use, and improve together without  
  https://nitter.netbub.com/jack/status/2099649359017046048#m
- @JosephJacks_ (Joseph Jacks, Mon, 14 Sep 2026): Effective altruists in shambles. 🇺🇸 Rapid Response 47 (@RapidResponse47) — https://nitter.netbub.com/RapidResponse47/status/2099597928142688610#m  
  https://nitter.netbub.com/DoWCTO/status/2099609988188553609#m
- @JosephJacks_ (Joseph Jacks, Mon, 14 Sep 2026): The newest members of the @planepowers team are getting their headshots done before launch. A little calm before the storm. Plane Agents drop this week.  
  https://nitter.netbub.com/viharkurama/status/2099607179355726096#m
- @a16zcrypto (a16z Crypto, Mon, 14 Sep 2026): The new CLARITY Act text reflects years of bipartisan negotiations and is stronger for it. I urge the Senate to vote to advance the bill tomorrow. Senator Cynthia Lummis (@SenLummis) After a year of intense daily bipartisan negotiations, this bill is ready. Here is the final text. President Trump voluntarily agreed to new ethics provisions holding every federally elected official, judge, and their spouses to some of the toughest ethics restrictions in U.S. history. This new text includes more than 120 of Democrats' demands. A no vote on Tuesday means opposing real ethics reforms on politicians  
  https://nitter.kareem.one/cdixon/status/2099591050956279968#m
- @JosephJacks_ (Joseph Jacks, Mon, 14 Sep 2026): This clip is why I love our design team: four transitions, each explaining a real product difference—one stack, agents built into the work, flexible deployment, and enterprise controls included. That's @planepowers! Video  
  https://nitter.netbub.com/viharkurama/status/2099580305275523357#m
- @a16zcrypto (a16z Crypto, Mon, 14 Sep 2026): Tomorrow, the Senate votes on whether to open debate on the CLARITY Act. If the bill becomes law, exchanges serving U.S. consumers will have to adopt safeguards that FTX lacked. If the bill doesn’t, those gaps will remain. miles jennings (@milesjennings) Article Only the U.S. Senate can prevent the next FTX Nearly four years have passed since FTX — the crypto exchange run by Sam Bankman-Fried and headquartered in the Bahamas — filed for bankruptcy. In that time Congress has held hearings, the Justice — https://nitter.kareem.one/milesjennings/status/2099517999069659389#m  
  https://nitter.kareem.one/a16zcrypto/status/2099521210283405631#m
- @a16zcrypto (a16z Crypto, Mon, 14 Sep 2026): Article Only the U.S. Senate can prevent the next FTX Nearly four years have passed since FTX — the crypto exchange run by Sam Bankman-Fried and headquartered in the Bahamas — filed for bankruptcy. In that time Congress has held hearings, the Justice  
  https://nitter.kareem.one/milesjennings/status/2099517999069659389#m
- @JosephJacks_ (Joseph Jacks, Mon, 14 Sep 2026): China's Foreign Ministry on AI: The development of AI bears on the well-being of all humanity. All parties should jointly promote the open and inclusive development of AI for good and for all. Fearmongering, confrontation and vicious competition will only disrupt the process of global AI governance, which serves no one’s interest. Video  
  https://nitter.netbub.com/clashreport/status/2099418131601006878#m
- @affine_io (Affine, Mon, 07 Sep 2026): A model doesn’t need to be the largest to matter. On Affine, models compete on how well their reasoning supports the next action across code, tool use and math. A winner could put that reasoning to work in products, either directly or alongside a larger model. Video  
  https://nitter.netbub.com/affine_io/status/2096984627059810338#m
...
- @TargonCompute (Targon, Fri, 21 Aug 2026): The Manifold team has had our heads down building, and we are excited to be making an apperance at @ExploitSummit very soon! We are looking forward to connecting with the community in Canada, and sharing the latest innovations in open stack inference and permissionless compute. Hope to see you all September 28-29th in Montreal 🍁 Exploit Summit (@ExploitSummit) Decentralization doesn't remove trust. It relocates it. @manifoldlabs took that head-on. @TargonCompute turned untrusted GPUs into confidential compute you can actually verify - and put the architecture in a paper co-authored with @intel  
  https://nitter.netbub.com/manifoldlabs/status/2090871513616433547#m
...
- @tplr_ai (Templar, Fri, 11 Sep 2026): Video  
  http://nitter.jaydenha.uk/tplr_ai/status/2098497911550017611#m
- @affine_io (Affine, Fri, 04 Sep 2026): Affine submissions are now private, so miners can compete without exposing their weights to competitors. Crowned models still go public. Losing checkpoints will be published later, so anyone can independently recompute every duel verdict. Video  
  https://nitter.netbub.com/affine_io/status/2095937147320844533#m


---
_Generated at 2026-09-15T02:52:50.664014+00:00 by scripts/intel/aggregate.py. Treat this digest as input context, not as ground truth. Verify before quoting._
