...
- @BarrySilbert (Barry Silbert, Wed, 16 Sep 2026): RT @Gylez: USDC to Alpha in 13 seconds. This is not a bridge. This is an intents based protocol to take Bittensor to the masses, live toda… Link TAO.com The original Bittensor wallet app for buying TAO and trading subnet tokens. tao.com  
  http://nitter.jaydenha.uk/BarrySilbert/status/2100232425372533154#m
...
- @BarrySilbert (Barry Silbert, Wed, 16 Sep 2026): In 1983, Steve Jobs warned that financial transactions alone could reveal your location, your habits, and your entire history. That was 43 years ago. Today, technology has advanced to a point where this reality is becoming invasive. Privacy has long been an overdue concern with minimal solutions. Zcash seeks to address this. Video  
  http://nitter.jaydenha.uk/ZcashETF/status/2100211398961996162#m
...
- @BarrySilbert (Barry Silbert, Wed, 16 Sep 2026): There is a new honey badger in town  
  http://nitter.jaydenha.uk/BarrySilbert/status/2100172741462618250#m
- @BarrySilbert (Barry Silbert, Wed, 16 Sep 2026): StableFX brings programmable FX to Arc. Available exclusively on Arc, Circle StableFX enables 24/7 onchain foreign exchange with fully-reserved stablecoins and near-instant settlement, built for global payments, treasury, and cross-currency financial workflows. Supported stablecoins include AUDD, AUDF, BRLA, CADD, CHFAU, EURAU, EURC, GBPA, JPYC, KRW1, MXNB, QCAD, SEKAU, TRYB, USDC, wARS, wBRL, wCLP, wCOP, wMXN, wPEN, and ZARU Issuers: @AgantFinance, @AllUnityStable, @AUDD_digital, @aveniaio, @BDACSKorea, @BiLira_Kripto, @ForteAUD, @jpyc_official, Juno (a @Bitso company), @LunoGlobal, @RipioApp  
  http://nitter.jaydenha.uk/arc/status/2100170560332333494#m
- @BarrySilbert (Barry Silbert, Wed, 16 Sep 2026): 🔥 NEW: Zcash holders vote to cut block times from 75 to 25 seconds and retain the network’s Bitcoin-style halving schedule.  
  http://nitter.jaydenha.uk/Cointelegraph/status/2100132743208149358#m
