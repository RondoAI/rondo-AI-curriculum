...
import { installCommandPalette } from './lib/command-palette.js?v=20260521b';
...
import { installMobileNav } from './lib/mobile-nav.js?v=20260521b'; */
...
import { mountHome } from './views/Home.js?v=20260521b';
...
import { mountDashboard } from './views/Dashboard.js?v=20260521b';
import { mountCockpit } from './views/Cockpit.js?v=20260521b';
import { mountTerminal } from './views/Terminal.js?v=20260521b';
import { mountPricing } from './views/Pricing.js?v=20260521b';
import { mountSignup  } from './views/Signup.js?v=20260521b';
