...
import { installCommandPalette } from './lib/command-palette.js?v=20260520h';
import { installMobileNav } from './lib/mobile-nav.js?v=20260520h';
...
import { mountHome } from './views/Home.js?v=20260520h';
...
import { mountDashboard } from './views/Dashboard.js?v=20260520h';
