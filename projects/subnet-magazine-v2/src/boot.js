...
import { installCommandPalette } from './lib/command-palette.js?v=20260520l';
import { installMobileNav } from './lib/mobile-nav.js?v=20260520l';
...
import { mountHome } from './views/Home.js?v=20260520l';
...
import { mountDashboard } from './views/Dashboard.js?v=20260520l';
import { mountCockpit } from './views/Cockpit.js?v=20260520l';
