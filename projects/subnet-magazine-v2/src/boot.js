...
import { installCommandPalette } from './lib/command-palette.js?v=20260522h';
...
import { installMobileNav } from './lib/mobile-nav.js?v=20260522h'; */
...
import { mountHome } from './views/Home.js?v=20260522h';
...
import { mountDashboard } from './views/Dashboard.js?v=20260522h';
import { mountCockpit } from './views/Cockpit.js?v=20260522h';
import { mountTerminal } from './views/Terminal.js?v=20260522h';
import { mountPricing } from './views/Pricing.js?v=20260522h';
import { mountSignup  } from './views/Signup.js?v=20260522h';
