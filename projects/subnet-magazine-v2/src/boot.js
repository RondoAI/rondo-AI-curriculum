...
import { installCommandPalette } from './lib/command-palette.js?v=20260521f';
...
import { installMobileNav } from './lib/mobile-nav.js?v=20260521f'; */
...
import { mountHome } from './views/Home.js?v=20260521f';
...
import { mountDashboard } from './views/Dashboard.js?v=20260521f';
import { mountCockpit } from './views/Cockpit.js?v=20260521f';
import { mountTerminal } from './views/Terminal.js?v=20260521f';
import { mountPricing } from './views/Pricing.js?v=20260521f';
import { mountSignup  } from './views/Signup.js?v=20260521f';
