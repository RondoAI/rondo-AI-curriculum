...
import { installCommandPalette } from './lib/command-palette.js?v=20260520q';
import { installMobileNav } from './lib/mobile-nav.js?v=20260520q';
...
import { mountHome } from './views/Home.js?v=20260520q';
...
import { mountDashboard } from './views/Dashboard.js?v=20260520q';
import { mountCockpit } from './views/Cockpit.js?v=20260520q';
import { mountTerminal } from './views/Terminal.js?v=20260520q';
import { mountPricing } from './views/Pricing.js?v=20260520q';
