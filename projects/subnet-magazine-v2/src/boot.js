...
import { installCommandPalette } from './lib/command-palette.js?v=20260520m';
import { installMobileNav } from './lib/mobile-nav.js?v=20260520m';
...
import { mountHome } from './views/Home.js?v=20260520m';
...
import { mountDashboard } from './views/Dashboard.js?v=20260520m';
import { mountCockpit } from './views/Cockpit.js?v=20260520m';
