...
import { installCommandPalette } from './lib/command-palette.js?v=20260522d';
...
import { installMobileNav } from './lib/mobile-nav.js?v=20260522d'; */
...
import { mountHome } from './views/Home.js?v=20260522d';
...
import { mountDashboard } from './views/Dashboard.js?v=20260522d';
import { mountCockpit } from './views/Cockpit.js?v=20260522d';
import { mountTerminal } from './views/Terminal.js?v=20260522d';
import { mountPricing } from './views/Pricing.js?v=20260522d';
import { mountSignup  } from './views/Signup.js?v=20260522d';
