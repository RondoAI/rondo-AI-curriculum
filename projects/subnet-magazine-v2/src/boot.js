...
import { installCommandPalette } from './lib/command-palette.js?v=20260520b';
...
import { mountHome } from './views/Home.js?v=20260520b';
...
import { mountDashboard } from './views/Dashboard.js?v=20260520b';
