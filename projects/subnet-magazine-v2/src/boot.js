...
import { installCommandPalette } from './lib/command-palette.js?v=20260521ac';
...
import { installMobileNav } from './lib/mobile-nav.js?v=20260521ac'; */
...
import { mountHome } from './views/Home.js?v=20260521ac';
...
import { mountDashboard } from './views/Dashboard.js?v=20260521ac';
import { mountCockpit } from './views/Cockpit.js?v=20260521ac';
import { mountTerminal } from './views/Terminal.js?v=20260521ac';
import { mountPricing } from './views/Pricing.js?v=20260521ac';
import { mountSignup  } from './views/Signup.js?v=20260521ac';
