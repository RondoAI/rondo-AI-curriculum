...
import { installCommandPalette } from './lib/command-palette.js?v=20260521y';
...
import { installMobileNav } from './lib/mobile-nav.js?v=20260521y'; */
...
import { mountHome } from './views/Home.js?v=20260521y';
...
import { mountDashboard } from './views/Dashboard.js?v=20260521y';
import { mountCockpit } from './views/Cockpit.js?v=20260521y';
import { mountTerminal } from './views/Terminal.js?v=20260521y';
import { mountPricing } from './views/Pricing.js?v=20260521y';
import { mountSignup  } from './views/Signup.js?v=20260521y';
