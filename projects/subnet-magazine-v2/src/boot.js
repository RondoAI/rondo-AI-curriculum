...
import { installCommandPalette } from './lib/command-palette.js?v=20260520g';
import { installMobileNav } from './lib/mobile-nav.js?v=20260520g';
...
import { mountHome } from './views/Home.js?v=20260520g';
...
import { mountDashboard } from './views/Dashboard.js?v=20260520g';
