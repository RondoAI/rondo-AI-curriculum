...
import { installCommandPalette } from './lib/command-palette.js?v=20260520n';
import { installMobileNav } from './lib/mobile-nav.js?v=20260520n';
...
import { mountHome } from './views/Home.js?v=20260520n';
...
import { mountDashboard } from './views/Dashboard.js?v=20260520n';
import { mountCockpit } from './views/Cockpit.js?v=20260520n';
import { mountTerminal } from './views/Terminal.js?v=20260520n';
