...
import { installCommandPalette } from './lib/command-palette.js?v=20260520k';
import { installMobileNav } from './lib/mobile-nav.js?v=20260520k';
...
import { mountHome } from './views/Home.js?v=20260520k';
