...
import { installCommandPalette } from './lib/command-palette.js?v=20260521ab';
...
import { installMobileNav } from './lib/mobile-nav.js?v=20260521ab'; */
...
import { mountHome } from './views/Home.js?v=20260521ab';
...
import { mountDashboard } from './views/Dashboard.js?v=20260521ab';
import { mountCockpit } from './views/Cockpit.js?v=20260521ab';
import { mountTerminal } from './views/Terminal.js?v=20260521ab';
import { mountPricing } from './views/Pricing.js?v=20260521ab';
import { mountSignup  } from './views/Signup.js?v=20260521ab';
