...
import { installCommandPalette } from './lib/command-palette.js?v=20260521u';
...
import { installMobileNav } from './lib/mobile-nav.js?v=20260521u'; */
...
import { mountHome } from './views/Home.js?v=20260521u';
...
import { mountDashboard } from './views/Dashboard.js?v=20260521u';
import { mountCockpit } from './views/Cockpit.js?v=20260521u';
import { mountTerminal } from './views/Terminal.js?v=20260521u';
import { mountPricing } from './views/Pricing.js?v=20260521u';
import { mountSignup  } from './views/Signup.js?v=20260521u';
