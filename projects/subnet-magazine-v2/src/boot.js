...
import { installCommandPalette } from './lib/command-palette.js?v=20260521ah';
...
import { installMobileNav } from './lib/mobile-nav.js?v=20260521ah'; */
...
import { mountHome } from './views/Home.js?v=20260521ah';
...
import { mountDashboard } from './views/Dashboard.js?v=20260521ah';
import { mountCockpit } from './views/Cockpit.js?v=20260521ah';
import { mountTerminal } from './views/Terminal.js?v=20260521ah';
import { mountPricing } from './views/Pricing.js?v=20260521ah';
import { mountSignup  } from './views/Signup.js?v=20260521ah';
