...
import { installCommandPalette } from './lib/command-palette.js?v=20260521m';
...
import { installMobileNav } from './lib/mobile-nav.js?v=20260521m'; */
...
import { mountHome } from './views/Home.js?v=20260521m';
...
import { mountDashboard } from './views/Dashboard.js?v=20260521m';
import { mountCockpit } from './views/Cockpit.js?v=20260521m';
import { mountTerminal } from './views/Terminal.js?v=20260521m';
import { mountPricing } from './views/Pricing.js?v=20260521m';
import { mountSignup  } from './views/Signup.js?v=20260521m';
