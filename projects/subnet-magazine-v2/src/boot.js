...
import { installCommandPalette } from './lib/command-palette.js?v=20260522a';
...
import { installMobileNav } from './lib/mobile-nav.js?v=20260522a'; */
...
import { mountHome } from './views/Home.js?v=20260522a';
...
import { mountDashboard } from './views/Dashboard.js?v=20260522a';
import { mountCockpit } from './views/Cockpit.js?v=20260522a';
import { mountTerminal } from './views/Terminal.js?v=20260522a';
import { mountPricing } from './views/Pricing.js?v=20260522a';
import { mountSignup  } from './views/Signup.js?v=20260522a';
