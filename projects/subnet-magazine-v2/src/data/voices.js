...
export const VOICES = Object.freeze([
  ...
  { handle:'manakoai',     name:'Manako', role:'Score\'s enterprise product layer', group:'subnet',
    site:'https://manako.ai', subnets:[44], expertise:['subnet'],
    bio:'The enterprise product layer built on Score (SN44). The "Business Operations World Model" that PwC France distributes. Self-described pitch: "Enterprises are sitting on one billion cameras that record everything and act on nothing. Manako turns that into real-time systems of action: lockdowns, dispatches, audit reports, workflow automations, across infrastructure that\'s already installed. Powered by Score (SN44)."' },
