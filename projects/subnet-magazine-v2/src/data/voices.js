...
export const VOICES = Object.freeze([
  ...
  { handle:'webuildscore', name:'Score', role:'Computer vision · Subnet 44', group:'subnet',
    ...
    bio:'Bittensor computer vision subnet. Made history as the FIRST subnet to partner with a Big Four professional services firm: PwC France signed a formal alliance to distribute Score\'s Manako product to enterprise clients across retail, manufacturing, logistics, energy, and infrastructure. PwC: \$60B revenue, 137 countries, now a distribution channel for a Bittensor subnet. Won the Bittensor track at Paris Blockchain Week.' },
