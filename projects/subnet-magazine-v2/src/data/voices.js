...
export const VOICES = Object.freeze([
  /* =========================================================
     ...
     ========================================================= */
  { handle:'const_reborn', name:'Jacob Steeves',  role:'Bittensor co-founder (Const) · Founder of Affine SN120 · Former CEO of OTF', group:'core',
    ...
    bio:'Known as Const. Co-founder of the Bittensor protocol and the Opentensor Foundation. Wrote the original TAO whitepaper, built Yuma Consensus, designed the subnet architecture. Stepped down as CEO of OTF in February 2026 as part of the governance transition Manifold covered in The Subnet Signal "Truly Open Intelligence" post (Feb 20 2026). Remains protocol co-founder and is now also founder of Affine (SN120), which runs continuous evaluations to fine-tune the best open-source reasoning models and hosts via Chutes (SN64) for a direct Affine-Chutes value loop. After the April 2026 Sam Dare / Templar incident, Const led the introduction of the Conviction mechanism. Per the May 15 Subnet Signal piece, Const described Conviction on his Thursday call as "a defensive tool meant to help teams guard against nefarious or spurious attacks", not as a competitive ownership market.' },
  ...
  { handle:'TargonCompute',name:'Targon', role:'Decentralized confidential-compute AI cloud · Subnet 4', group:'subnet',
    site:'https://targon.com', subnets:[4], expertise:['subnet','miner','validator'],
    bio:'Built by Manifold Labs. Permissionless network where hardware providers contribute Intel-TDX + NVIDIA-CC capable nodes and receive uniquely encrypted Ubuntu 24.04 Confidential VMs that can be decrypted only after successful remote attestation through Intel\'s Key Broker Service. Continuous re-attestation every ~72 minutes with validator-nonce challenge-response. IP-bound to prevent VM migration. 5-layer architecture (hardware, CVM provisioning, attestation, incentives, Kubernetes orchestration over WireGuard mesh) documented in the joint Intel x Manifold paper published on Intel\'s community blog Mar 17 2026 (authors: Venish Patidar, Dhruv Bindra, Ahmed Darwich, Josh Brown from Manifold; Haidong Xia, Sathi Nair from Intel). Targon OS launching to extend network to consumer GPUs (4090s, 3090s) at a separate trust tier. Powers @dippy_ai (8M+ users). Built by @0xcarro (Robert Myers, one of the first three in the Bittensor Discord) and @jameswoodmanv (ex-GSR).' },
  { handle:'robmyers',     name:'Robert Myers', role:'CEO · Manifold Labs / Targon (SN4)', group:'subnet',
    site:'https://targon.com', subnets:[4], expertise:['subnet','miner','validator'],
    bio:'CEO of Manifold Labs, the team behind Targon (SN4). Also handle @0xcarro. One of the first three people in the Bittensor Discord. On the record in the joint Intel x Manifold TDX paper (Mar 17 2026): "Intel TDX enables secure VM isolation with minimal overhead, while Intel Trust Authority provides verifiable remote attestation that can be embedded into validator workflows. This combination allows us to establish strong trust assurances at the protocol level rather than relying on operator reputation." That sentence is the cleanest available summary of why decentralized confidential compute matters as a category.' },
  ...
  /* — surfaced via Manifold's Subnet Signal newsletter, May 15 2026 — */
  { handle:'compelle_ai',  name:'Compelle', role:'Structured AI-model debate · Subnet 82', group:'subnet',
    site:'https://compelle.ai', subnets:[82], expertise:['subnet'],
    bio:'Runs structured debates between AI models to produce higher-quality outputs. Mainnet May 8 2026; took over the slot the same day after Hermes was deregistered. 4,700 debate games in week one. Handle is a placeholder pending confirmation.' },
  { handle:'mvtrx_io',     name:'MVTRX', role:'DEX infrastructure for dTAO trading · Subnet 79', group:'subnet',
    site:'https://mvtrx.io', subnets:[79], expertise:['subnet'],
    bio:'Builds decentralized exchange infrastructure for dTAO trading, optimized for AI agents. Per The Subnet Signal (May 15 2026), a recent validator upgrade expanded simulation capacity to 128 parallel books; next update adds live Observe Mode, 3D order-book visualization, and a UID relationship explorer. Handle is a placeholder pending confirmation.' },
  { handle:'harnyx_io',    name:'Harnyx', role:'Deep research as commodity · Subnet 67', group:'subnet',
    site:'https://harnyx.io', subnets:[67], expertise:['subnet'],
    bio:'Positions deep research as a commodity: miners compete to produce traceable research reports faster and cheaper than expert analysis. Targeting the agent economy as an infrastructure layer. Early-access waitlist open per The Subnet Signal May 15 2026. Handle is a placeholder pending confirmation.' },
  { handle:'ditto_subnet', name:'Ditto', role:'Persistent memory for AI agents · Subnet 118', group:'subnet',
    site:'https://ditto.ai', subnets:[118], expertise:['subnet'],
    bio:'Persistent memory and knowledge graph infrastructure for AI agents. Up 128 percent on the week ending May 15 2026. Powers agents like OpenClaw via MCP with 700+ users. Recent slot takeover plus open-source launch driving momentum. Handle is a placeholder pending confirmation.' },
  { handle:'bitsec_ai',    name:'Bitsec', role:'AI security auditing · Subnet 60', group:'subnet',
    site:'https://bitsec.ai', subnets:[60], expertise:['subnet'],
    bio:'AI-driven security auditing: automatically finds bugs and vulnerabilities in code and smart contracts. Up 23 percent on the week ending May 15 2026 on recent customer wins. Editorial framing: as AI-generated code grows, automated security review becomes a critical surface. Handle is a placeholder pending confirmation.' },
  { handle:'niome_bio',    name:'NIOME', role:'AI + biology for drug discovery · Subnet 55', group:'subnet',
    site:'https://niome.bio', subnets:[55], expertise:['subnet'],
    bio:'Connects real biology data with AI for drug discovery and personalized medicine. Up 22 percent on the week ending May 15 2026 on a new Scottish government partnership and an upcoming summit. Handle is a placeholder pending confirmation.' },
  { handle:'babelbit_io',  name:'Babelbit', role:'Decentralized translation · Subnet 59', group:'subnet',
    site:'https://babelbit.io', subnets:[59], expertise:['subnet'],
    bio:'Decentralized translation infrastructure. Up 22 percent on the week ending May 15 2026 on progress updates and founder interviews. Mission framing: making high-quality translation cheap and globally available. Handle is a placeholder pending confirmation.' },
  { handle:'virajdotai',   name:'Viraj Sahu', role:'Manifold Labs operator · The Subnet Signal author', group:'media',
    site:'https://manifold.inc', subnets:[4], expertise:['subnet'],
    bio:'Operates at Manifold Labs (the team behind Targon SN4 and co-author of the March 2026 Intel x Manifold TDX paper). Writes The Subnet Signal newsletter on Substack, the cleanest in-ecosystem mechanism analysis the desk currently tracks (e.g. the May 15 piece "Conviction Will Be Quiet" on the post-Templar governance changes). Manifold serves simultaneously as subnet operator, academic paper co-author, and media publisher; treat the editorial voice as professional but read coverage of competing decentralized compute layers with positioned-voice awareness. Handle is a placeholder pending confirmation.' },

  /* — external macro publications the desk tracks (not Bittensor-native) — */
  { handle:'dylan522p',    name:'Dylan Patel', role:'Founder · SemiAnalysis · the AI infrastructure analyst', group:'media',
    site:'https://semianalysis.com', subnets:[], expertise:[],
    bio:'Founder of SemiAnalysis, the most-cited semiconductor and AI infrastructure publication in the industry. Co-author of the May 1 2026 piece "AI Value Capture: The Shift to Model Labs" that documents Anthropic ARR growth from $9B to $44B+ YTD, inference margins moving from 38 to 70 percent, and the structural compute scarcity that drives the macro setup Bittensor operates against. SemiAnalysis does NOT cover Bittensor; the magazine tracks them for macro context only. If Bittensor ever wants on the analyst radar, Dylan\'s X handle and the SemiAnalysis newsletter are the surface to seed.' },
  { handle:'SemiAnalysis_',name:'SemiAnalysis', role:'Macro AI infrastructure publication (external)', group:'media',
    site:'https://semianalysis.com', subnets:[], expertise:[],
    bio:'Independent semiconductor and AI infrastructure analysis publication founded by Dylan Patel. The most rigorous analyst voice on compute economics, hyperscaler pricing power, GPU rental ecosystems, memory market dynamics, and TSMC/Nvidia capacity. Does not yet cover Bittensor. Magazine tracks them as macro context: the conditions SemiAnalysis documents (compute scarcity, hyperscaler pricing power, AI lab margin expansion, antitrust constraints on Nvidia pricing) ARE the macro thesis Bittensor operates against. Handle is a placeholder pending confirmation.' },
